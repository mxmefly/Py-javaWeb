					...
					<el-col :span="24" :xs="24" :sm="16" :md="16" :lg="16">
						<div class="login-form">
							<div class="card-block">
								<h1>管理员登录</h1>
								<p class="text-muted">请确保登陆环境安全</p>
								<div class="input-group m-b-1">
									<span class="input-group-addon"><i class="el-icon-ex-people"></i></span>
									<input type="text" class="form-control" placeholder="user name" v-model="loginForm.username">
								</div>
								<div class="input-group m-b-2">
									<span class="input-group-addon"><i class="el-icon-ex-unlock"></i></span>
									<input type="password" class="form-control" placeholder="password" v-model="loginForm.password" @keyup.enter="handleLogin">
								</div>
								<div class="row">
									<el-row>
										<el-col :span="12">
											<el-button type="primary" class="btn btn-primary p-x-2" @click="handleLogin">登录
											</el-button>
										</el-col>
									</el-row>
								</div>
					...
					<el-col :span="24" :xs="24" :sm="8" :md="8" :lg="8">
						<div class="login-register">
							<div class="card-block">
								<h2>游客</h2>
								<p>仅查看数据展示</p>
								<el-button type="info" style="background-color: #0086B3; border: 0;" @click="handleTouristLogin"> 游客登录</el-button>
							</div>
						</div>
					</el-col>
				</el-row>
