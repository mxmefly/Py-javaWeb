! function(e, t) {
	"object" == typeof exports && "undefined" != typeof module ? module.exports = t(require("echarts/lib/echarts"),
		require("echarts/lib/component/tooltip"), require("echarts/lib/component/legend"), require("echarts/lib/chart/bar"),
		require("echarts/lib/chart/line"), require("echarts/lib/chart/pie"), require("echarts/lib/chart/funnel"), require(
			"echarts/lib/chart/radar"), require("echarts/lib/chart/map"), require("echarts/extension/bmap/bmap"), require(
			"echarts-amap"), require("echarts/lib/chart/sankey"), require("echarts/lib/chart/heatmap"), require(
		...
		require("echarts-liquidfill"), require("echarts-wordcloud")) : "function" == typeof define && define.amd ? define([
		"echarts/lib/echarts", "echarts/lib/component/tooltip", "echarts/lib/component/legend", "echarts/lib/chart/bar",
		"echarts/lib/chart/line", "echarts/lib/chart/pie", "echarts/lib/chart/funnel", "echarts/lib/chart/radar",
		"echarts/lib/chart/map", "echarts/extension/bmap/bmap", "echarts-amap", "echarts/lib/chart/sankey",
		"echarts/lib/chart/heatmap", "echarts/lib/component/visualMap", "echarts/lib/chart/scatter",
		"echarts/lib/chart/candlestick", "echarts/lib/component/dataZoom", "echarts/lib/chart/gauge",
		"echarts/lib/chart/tree", "echarts-liquidfill", "echarts-wordcloud"
	], t) : e.VeIndex = t(e.echarts)
}(this, function(e) {
	"use strict";
	...
	var t = {
		...
		i = ["#19d4ae", "#5ab1ef", "#fa6e86", "#ffb980", "#0067a6", "#c4b4e4", "#d87a80", "#9cbbff", "#d9d0c7", "#87a997",
			"#d49ea2", "#5b4947", "#7ba3a8"
		],
		n = ["#313695", "#4575b4", "#74add1", "#abd9e9", "#e0f3f8", "#ffffbf", "#fee090", "#fdae61", "#f46d43", "#d73027",
			"#a50026"
		],
		a = ["blue", "blue", "green", "yellow", "red"],
		r = function(e) {
			return ['<span style="', "background-color:" + e + ";", "display: inline-block;", "width: 10px;", "height: 10px;",
				"border-radius: 50%;", "margin-right:2px;", '"></span>'
			].join("")
		},
		o = ["initOptions", "loading", "dataEmpty", "judgeWidth", "widthChangeDelay"],
		s = ["grid", "dataZoom", "visualMap", "toolbox", "title", "legend", "xAxis", "yAxis", "radar", "tooltip",
			"axisPointer", "brush", "geo", "timeline", "graphic", "series", "backgroundColor", "textStyle"
		],
		l = {
			th: 3,
			mi: 6,
	...
	function f(e, t, i, n) {
		var a = Math.abs(t),
			...
			v = void 0,
			b = void 0;
		i = i || "", t = t || 0, ~i.indexOf("(") ? (r = !0, i = i.replace(/[(|)]/g, "")) : (~i.indexOf("+") || ~i.indexOf(
			"-")) && (b = ~i.indexOf("+") ? i.indexOf("+") : t < 0 ? i.indexOf("-") : -1, i = i.replace(/[+|-]/g, "")), ~i.indexOf(
			"a") && (v = !!(v = i.match(/a(k|m|b|t)?/)) && v[1], ~i.indexOf(" a") && (s = " "), i = i.replace(new RegExp(s +
				"a[kmbt]?"), ""), a >= u && !v || "t" === v ? (s += e.abbrLabel.tr, t /= u) : a < u && a >= d && !v || "b" === v ?
			(s += e.abbrLabel.bi, t /= d) : a < d && a >= m && !v || "m" === v ? (s += e.abbrLabel.mi, t /= m) : (a < m && a >=
				p && !v || "k" === v) && (s += e.abbrLabel.th, t /= p)), ~i.indexOf("[.]") && (o = !0, i = i.replace("[.]", "."));
		var y = t.toString().split(".")[0],
			g = i.split(".")[1],
			x = i.indexOf(","),
			w = (i.split(".")[0].split(",")[0].match(/0/g) || []).length;
		if (g ? (y = (c = ~g.indexOf("[") ? h(t, (g = (g = g.replace("]", "")).split("["))[0].length + g[1].length, n, g[1].length) :
				h(t, g.length, n)).split(".")[0], c = ~c.indexOf(".") ? "." + c.split(".")[1] : "", o && 0 == +c.slice(1) && (c =
				"")) : y = h(t, 0, n), s && !v && +y >= 1e3 && s !== l.trillion && (y = "" + +y / 1e3, s = l.million), ~y.indexOf(
				"-") && (y = y.slice(1), f = !0), y.length < w)
			for (var S = w - y.length; S > 0; S--) y = "0" + y;
		x > -1 && (y = y.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,")), i.indexOf(".") || (y = "");
		var A = y + c + (s || "");
		return r ? A = (r && f ? "(" : "") + A + (r && f ? ")" : "") : b >= 0 ? A = 0 === b ? (f ? "-" : "+") + A : A + (f ?
			"-" : "+") : f && (A = "-" + A), A
	}
	...
	function g(e, t, i) {
		return function(e, t, i) {
			...
			}(e) ? null : "string" == typeof e ? b.zeroFormat && e === b.zeroFormat ? 0 : b.nullFormat && e === b.nullFormat ||
			!e.replace(/[^0-9]+/g, "").length ? null : +e : +e || null, t, i)
	}
	v(b, c), g.options = b, g._numberToFormat = f.bind(null, b), g.register = function(e, t) {
		...
		format: function(e, t, i, n) {
			var a = ~t.indexOf(" %") ? " " : "",
				r = void 0;
			return n.options.scalePercentBy100 && (e *= 100), t = t.replace(/\s?%/, ""), ~(r = n._numberToFormat(e, t, i)).indexOf(
				")") ? ((r = r.split("")).splice(-1, 0, a + "%"), r = r.join("")) : r = r + a + "%", r
		}
	});
	...
	var V = "function" == typeof Symbol && "symbol" === x(Symbol.iterator) ? function(e) {
		...
		return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : void 0 ===
			e ? "undefined" : x(e)
	};
	...
	var z = function(e, t, i) {
		...
		P = function(e, t) {
			return F || (F = new Promise(function(i, n) {
				...
				r.src = ["https://api.map.baidu.com/api?v=" + (t || "2.0"), "ak=" + e, "callback=" + a].join("&"), document.body
					.appendChild(r)
			})), F
		},
		D = function(e, t) {
			return _ || (_ = new Promise(function(i, n) {
				...
				window[a] = i;
				var r = document.createElement("script");
				r.src = ["https://webapi.amap.com/maps?v=" + (t || "1.4.3"), "key=" + e, "callback=" + a].join("&"), document.body
					.appendChild(r)
			})), _
		};
	...
	function B(e) {
		for (var t = e.meaAxisName, i = e.meaAxisType, n = e.axisVisible, a = e.digit, r = e.scale, o = e.min, s = e.max, l = {
				...
				i[e] ? c[e] = S({}, l, {
					...
					}) : c[e] = S({}, l), c[e].name = t[e] || "", c[e].scale = r[e] || !1, c[e].min = o[e] || null, c[e].max = s[e] ||
					null
			}, d = 0; d < 2; d++) u(d);
		return c
	}
	...
	function I(e) {
		...
		return n.forEach(function(e) {
			...
			return "value" === m && (n.barGap = p, n.barCategoryGap = "1%", null == r && (r = $)), null != r && M(n,
				"itemStyle.normal.opacity", r), n
		})).length && t
	}
	...
	var U = function(e, t, i, n) {
			var a = j(t),
				...
				C = n.legendVisible,
				H = e.slice();
			o.top && o.bottom ? H = o.top.concat(o.bottom) : o.bottom && !o.right ? H = o.bottom : i.metrics ? H = i.metrics :
		...
		Y = function(e, t, i, n) {
			...
			var H = n.tooltipVisible,
				F = n.legendVisible,
				_ = e.slice();
			o.left && o.right ? _ = o.left.concat(o.right) : o.left && !o.right ? _ = o.left : i.metrics ? _ = i.metrics : _.splice(
				e.indexOf(l[0]), 1);
	...
	var ee = {
			...
			methods: {
				...
				resize: function() {
					this.cancelResizeCheck ? this.echartsResize() : this.$el && this.$el.clientWidth && this.$el.clientHeight &&
						this.echartsResize()
				},
				...
				optionsHandler: function(t) {
					var i = this;
					if (this.legendPosition && t.legend && (t.legend[this.legendPosition] = 10, ~["left", "right"].indexOf(this.legendPosition) &&
							(t.legend.top = "middle", t.legend.orient = "vertical")), t.color = this.chartColor, s.forEach(function(e) {
							i[e] && (t[e] = i[e])
					...
					this.extend && function(e, t) {
						Object.keys(t).forEach(function(i) {
							var n = t[i];
							~i.indexOf(".") ? M(e, i, n) : "function" == typeof n ? e[i] = n(e[i]) : L(e[i]) && k(e[i][0]) ? e[i].forEach(
								function(t, a) {
									e[i][a] = S({}, t, n)
					...
					!this.settings.bmap && !this.settings.amap || k(r) || (r = !1), this.notSetUnchange && this.notSetUnchange.length &&
						...
						}), k(r) ? r.notMerge = !1 : r = !1), this._isDestroyed || (this.log && console.log(t), this.echarts.setOption(
								t, r), this.$emit("ready", this.echarts, t, e), this._once["ready-once"] || (this._once["ready-once"] = !0,
								this.$emit("ready-once", this.echarts, t, e)), this.judgeWidth && this.judgeWidthHandler(t), this.afterSetOption &&
							this.afterSetOption(this.echarts, t, e), this.afterSetOptionOnce && !this._once.afterSetOptionOnce && (this._once
								.afterSetOptionOnce = !0, this.afterSetOptionOnce(this.echarts, t, e)))
				},
				...
				init: function() {
					if (!this.echarts) {
						...
						this.echarts = e.init(this.$refs.canvas, i, this.initOptions), this.data && this.changeHandler(), this.createEventProxy(),
			...
			created: function() {
				this.echarts = null, this.registeredEvents = [], this._once = {}, this._store = {}, this.resizeHandler = O(this.resize,
					this.resizeDelay), this.changeHandler = O(this.dataHandler, this.changeDelay), this.addWatchToProps()
			},
			mounted: function() {
				this.init()
			},
	...
	var ne = function(e, t, i, n) {
			...
			var a = i.axisSite,
				...
				W = e.slice();
			r.left && r.right ? W = r.left.concat(r.right) : r.left && !r.right ? W = r.left : i.metrics ? W = i.metrics : W.splice(
				e.indexOf(p[0]), 1);
			var I = G && function(e) {
					var t = e.metrics,
						i = e.legendName,
				...
				U = function(e) {
					for (var t = e.yAxisName, i = e.yAxisType, n = e.axisVisible, a = e.scale, r = e.min, o = e.max, s = e.digit, l = {
							...
							}) : c[e] = S({}, l), c[e].name = t[e] || "", c[e].scale = a[e] || !1, c[e].min = r[e] || null, c[e].max = o[
								e] || null
						}, d = 0; d < 2; d++) u(d);
					return c
				}({
			...
			return {
				...
				series: function(e) {
					...
					return n.forEach(function(e) {
						...
						a && (t.areaStyle = {
							normal: {}
						}), i.right && (t.yAxisIndex = ~i.right.indexOf(e) ? 1 : 0), r && f[e] && (t.stack = f[e]), l && (t.label =
							l), c && (t.itemStyle = c), u && (t.lineStyle = u), d && (t.areaStyle = d), p.push(t)
					}), p
				}({
					rows: t,
					axisSite: r,
			...
			return _ && o.sort(function(e, t) {
				...
				series: function(e) {
					...
					if (x.forEach(function(e, t) {
							...
							}), m && (s.label = m), v && (s.labelLine = v), b && (s.itemStyle = b), n && (s.label = {
								normal: {
									show: !0,
						...
						O.slice(h, O.length).forEach(function(e) {
							M += e.value
						}), y[0].data = O.slice(0, h), y[0].data.push({
							name: "其他",
							value: M
						})
					}
	...
	var de = function(e, t, i, n) {
			...
			var O = A[0],
				...
				T = parseFloat(t.reduce(function(e, t) {
					return e + Number(t[O])
				}, 0).toFixed(x)),
				N = function(e, t) {
			...
			var S = x && function(e, t, i) {
				...
				A = function(e, t, i) {
					...
					return e.forEach(function(e) {
						...
						return {
							name: e,
							max: Math.max.apply(null, a[e])
						}
					}), n
				}(t, w, u);
			return {
				legend: S,
				tooltip: g && function(e, t, i) {
					var n = [],
						a = [];
	...
	var xe = function(e, t, i, n) {
					...
					return {
						formatter: function(s) {
							...
							return s.name ? (l.push(s.name + "<br>"), n.forEach(function(n, c) {
								...
								l.push(r(a[c]) + " " + u + " : "), i[s.name] ? l.push(z(i[s.name][n], e[n], t)) : l.push("-"), l.push(
									"<br>")
							}), l.join(" ")) : ""
						}
					}
		...
		Se = function(e, t, i, n) {
			var a = i.key,
				...
				s = i.useOuterMap,
				l = n._once;
			return a || s || console.warn("settings.key must be a string."), l.bmap_register ? {} : (l.bmap_register = !0, s ? {
				bmap: o
		...
		Oe = function(e, t, i, n) {
			var a = i.key,
				...
				s = i.useOuterMap,
				l = n._once;
			return a || s || console.warn("settings.key must be a string."), l.amap_register ? {} : (l.amap_register = !0, s ? {
				amap: o
					...
					return {
						...
						formatter: function(e) {
							var a = [],
								...
								l = e.value,
								c = e.color;
							return a.push(r(c)), a.push(o + " : "), s && s.source ? a.push(z(l, i, n) + "<br />") : a.push(z(l, t, n) +
								"<br />"), a.join("")
						}
					}
				}({
	...
	var je = function(t, i, o, s) {
			...
			return "bmap" === c ? (S(le.series[0], {
				...
				return j && (t = j(t)), e.registerMap(k, t, Z), S({
					geo: i
				}, le)
				...
				series: function(e) {
					...
					return a.slice().map(function(e, a) {
						var l = [],
							...
							d = Number(e[i]),
							m = {};
						return L(n) ? m = n[a] ? n[a] : n[s - 1] : k(n[u]) && (m = n[u]), L(r) && L(r[0]) && (o = L(r[a]) ? r[a] : r[
							r.length - 1]), l.push({
							value: d
						}), o && o.length && (l = l.concat(o.map(function(e) {
							return {
								value: e
							}
						}))), c = S(c, {
				...
				series: function(e) {
					var t = e.dimension,
							...
							textStyle: {
								normal: {
									color: !L(a) && a ? a : function() {
										return "rgb(" + [Math.round(160 * Math.random()), Math.round(160 * Math.random()), Math.round(160 * Math.random())]
											.join(",") + ")"
									}
								}
							},
						...
						u = n.slice().map(function(e) {
							...
							return c > 0 && (n.textStyle = {
								normal: {
									color: a[Math.floor(Math.random() * c)]
								}
							}), n
						});
					return l.data = u, [l]
