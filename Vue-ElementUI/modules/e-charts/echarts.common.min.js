...
! function(t, e) {
	...
	function d(t, e, n) {
		if (t && e)
			if (t.forEach && t.forEach === ng) t.forEach(e, n);
	...
	function rt(t, e, n, i) {
		return n = n || {}, i || !Kp.canvasSupported ? ot(t, e, n) : Kp.browser.firefox && null != e.layerX && e.layerX !==
			e.offsetX ? (n.zrX = e.layerX, n.zrY = e.layerY) : null != e.offsetX ? (n.zrX = e.offsetX, n.zrY = e.offsetY) : ot(
				t, e, n), n
	}
	...
	function wt(t, e, n) {
		var i = e[0],
			...
			h = Math.sin(n),
			u = Math.cos(n);
		return t[0] = i * u + a * h, t[1] = -i * h + a * u, t[2] = r * u + s * h, t[3] = -r * h + u * s, t[4] = u * o + h *
			l, t[5] = u * l - h * o, t
	}
	...
	function Nt(t, e) {
		if (t) {
			...
			if ("#" !== i.charAt(0)) {
				...
				if (4 === i.length) return (h = parseInt(i.substr(1), 16)) >= 0 && h <= 4095 ? (Ot(e, (3840 & h) >> 4 | (3840 & h) >>
					8, 240 & h | (240 & h) >> 4, 15 & h | (15 & h) << 4, 1), Et(t, e), e) : void Ot(e, 0, 0, 0, 1);
				if (7 === i.length) {
					var h = parseInt(i.substr(1), 16);
					return h >= 0 && h <= 16777215 ? (Ot(e, (16711680 & h) >> 16, (65280 & h) >> 8, 255 & h, 1), Et(t, e), e) : void Ot(
						e, 0, 0, 0, 1)
				}
			}
		}
	...
	function Rt(t, e) {
		var n = (parseFloat(t[0]) % 360 + 360) % 360 / 360,
			...
			o = r <= .5 ? r * (i + 1) : r + i - r * i,
			a = 2 * r - o;
		return e = e || [], Ot(e, Tt(255 * Pt(a, o, n + 1 / 3)), Tt(255 * Pt(a, o, n)), Tt(255 * Pt(a, o, n - 1 / 3)), 1), 4 ===
			t.length && (e[3] = t[3]), e
	}
		...
		if (t) {
			...
			if (0 === l) e = 0, n = 0;
				...
				var u = ((s - i) / 6 + l / 2) / l,
					c = ((s - r) / 6 + l / 2) / l,
					d = ((s - o) / 6 + l / 2) / l;
				i === s ? e = d - c : r === s ? e = 1 / 3 + u - d : o === s && (e = 2 / 3 + c - u), e < 0 && (e += 1), e > 1 && (e -=
					1)
			}
			var f = [360 * e, n, h];
	...
	function Ht(t, e, n) {
		if (e && e.length && t >= 0 && t <= 1) {
			...
			var i = t * (e.length - 1),
				...
				s = e[o],
				l = i - r;
			return n[0] = Tt(Lt(a[0], s[0], l)), n[1] = Tt(Lt(a[1], s[1], l)), n[2] = Tt(Lt(a[2], s[2], l)), n[3] = Ct(Lt(a[3],
				s[3], l)), n
		}
	}
	...
	function qt(t, e, n, i, r) {
		var o = t.length;
		if (1 === r)
			for (s = 0; s < o; s++) i[s] = Yt(t[s], e[s], n);
		else
			for (var a = o && t[0].length, s = 0; s < o; s++)
				for (var l = 0; l < a; l++) i[s][l] = Yt(t[s][l], e[s][l], n)
	}
	...
	function $t(t, e, n) {
		...
		if (i !== r)
			if (i > r) t.length = r;
				...
				for (a = i; a < r; a++) t.push(1 === n ? e[a] : qg.call(e[a]));
	...
	function Qt(t, e, n, i, r, o, a, s, l) {
		var h = t.length;
		if (1 === l)
			for (c = 0; c < h; c++) s[c] = Jt(t[c], e[c], n[c], i[c], r, o, a);
		else
			for (var u = t[0].length, c = 0; c < h; c++)
				for (var d = 0; d < u; d++) s[c][d] = Jt(t[c][d], e[c][d], n[c][d], i[c][d], r, o, a)
	}
			...
			if (o || !x) {
				...
				var O = new It({
					...
					onframe: function(t, e) {
						...
						if (0 !== i)
							if (I = (e - m[n]) / i, l)
								if (A = v[n], T = v[0 === n ? n : n - 1], C = v[n > h - 2 ? h - 1 : n + 1], D = v[n > h - 3 ? h - 1 : n + 2],
									d) Qt(T, A, C, D, I, I * I, I * I * I, a(t, r), g);
								else {
									if (f) o = Qt(T, A, C, D, I, I * I, I * I * I, L, 1), o = ee(L);
									else {
						...
						else if (d) qt(v[n], v[n + 1], I, a(t, r), g);
						else {
							var o;
							if (f) qt(v[n], v[n + 1], I, L, 1), o = ee(L);
							else {
	...
	function re(t, e, n, i, r, o, a, s) {
		_(i) ? (o = r, r = i, i = 0) : x(r) ? (o = r, r = "linear", i = 0) : x(i) ? (o = i, i = 0) : x(n) ? (o = n, n = 500) :
			n || (n = 500), t.stopAnimation(), oe(t, "", t, e, n, i, s);
	...
	function oe(t, e, n, i, r, o, a) {
		var s = {},
			l = 0;
		for (var h in i) i.hasOwnProperty(h) && (null != n[h] ? w(i[h]) && !c(i[h]) ? oe(t, e ? e + "." + h : h, n[h], i[h],
			r, o, a) : (a ? (s[h] = n[h], ae(t, e, h, i[h])) : s[h] = i[h], l++) : null == i[h] || a || ae(t, e, h, i[h]));
	...
	function Fe(t, e) {
		...
		for (k = 0; k < a.length; k++) {
			for (var p = a[k], g = 0, m = 0, v = 0; v < p.tokens.length; v++) {
				...
				if (x && (w += x[0] + x[2]), P.height = w, P.lineHeight = C(y.textLineHeight, e.textLineHeight, w), P.textAlign =
		...
		n.outerWidth = n.width = A(e.textWidth, l), n.outerHeight = n.height = A(e.textHeight, s), u && (n.outerWidth += u[1] +
	...
	function We(t, e) {
		var n, i, r, o, a = e.x,
			...
			h = e.height,
			u = e.r;
		l < 0 && (a += l, l = -l), h < 0 && (s += h, h = -h), "number" == typeof u ? n = i = r = o = u : u instanceof Array ?
			1 === u.length ? n = i = r = o = u[0] : 2 === u.length ? (n = r = u[0], i = o = u[1]) : 3 === u.length ? (n = u[0],
				i = o = u[1], r = u[2]) : (n = u[0], i = u[1], r = u[2], o = u[3]) : n = i = r = o = 0;
		var c;
		n + i > l && (n *= l / (c = n + i), i *= l / c), r + o > l && (r *= l / (c = r + o), o *= l / c), i + r > h && (i *=
				h / (c = i + r), r *= h / c), n + o > h && (n *= h / (c = n + o), o *= h / c), t.moveTo(a + n, s), t.lineTo(a + l -
				i, s), 0 !== i && t.arc(a + l - i, s + i, i, -Math.PI / 2, 0), t.lineTo(a + l, s + h - r), 0 !== r && t.arc(a + l -
				r, s + h - r, r, 0, Math.PI / 2), t.lineTo(a + o, s + h), 0 !== o && t.arc(a + o, s + h - o, o, Math.PI / 2, Math.PI),
	...
	function Ze(t) {
		if (t) {
			...
			"center" === n && (n = "middle"), t.textVerticalAlign = null == n || Pm[n] ? n : "top", t.textPadding && (t.textPadding =
				k(t.textPadding))
		}
	}
	...
	function Xe(t, e, n, i, r, o) {
		...
		o !== fm ? (o && (a = o.style, l = !s && h && a), e.__attrCachedBy = s ? dm.NONE : dm.PLAIN_TEXT) : h && (e.__attrCachedBy =
			dm.NONE);
		var u = i.font || Dm;
		...
		var L = i.textStrokeWidth,
			...
			N = nn(i.textStroke, L),
			R = rn(i.textFill);
		if (N && (z && (e.lineWidth = L), E && (e.strokeStyle = N)), R && (l && i.textFill === a.textFill || (e.fillStyle =
				R)), 1 === m.length) N && e.strokeText(m[0], M, I), R && e.fillText(m[0], M, I);
		else
			for (var B = 0; B < m.length; B++) N && e.strokeText(m[B], M, I), R && e.fillText(m[B], M, I), I += v
	}
	...
	function je(t, e, n, i, r) {
		...
		for (var x = 0; x < n.lines.length; x++) {
			for (var _, w = n.lines[x], b = w.tokens, S = b.length, M = w.lineHeight, I = w.width, T = 0, A = m, C = y, D = S -
					1; T < S && (!(_ = b[T]).textAlign || "left" === _.textAlign);) $e(t, e, _, i, M, v, A, "left"), I -= _.width, A +=
				_.width, T++;
			for (; D >= 0 && "right" === (_ = b[D]).textAlign;) $e(t, e, _, i, M, v, C, "right"), I -= _.width, C -= _.width, D--;
			for (A += (o - (A - m) - (y - C) - I) / 2; T <= D;) $e(t, e, _ = b[T], i, M, v, A + _.width / 2, "center"), A += _.width,
				T++;
			v += M
		}
	}
	...
	function $e(t, e, n, i, r, o, a, s) {
		...
		var h = n.textVerticalAlign,
			u = o + r / 2;
		"top" === h ? u = o + n.height / 2 : "bottom" === h && (u = o + r - n.height / 2), !n.isLineHolder && Ke(l) && Qe(t,
			e, l, "right" === s ? a - n.width : "center" === s ? a - n.width / 2 : a, u - n.height / 2, n.width, n.height);
		var c = n.textPadding;
		c && (a = an(a, s, c), u -= n.height / 2 - c[2] - n.textHeight / 2), en(e, "shadowBlur", C(l.textShadowBlur, i.textShadowBlur,
			0)), en(e, "shadowColor", l.textShadowColor || i.textShadowColor || "transparent"), en(e, "shadowOffsetX", C(l.textShadowOffsetX,
			i.textShadowOffsetX, 0)), en(e, "shadowOffsetY", C(l.textShadowOffsetY, i.textShadowOffsetY, 0)), en(e,
			"textAlign", s), en(e, "textBaseline", "middle"), en(e, "font", n.font || Dm);
		var d = nn(l.textStroke || i.textStroke, p),
			f = rn(l.textFill || i.textFill),
			p = A(l.textStrokeWidth, i.textStrokeWidth);
		d && (en(e, "lineWidth", p), en(e, "strokeStyle", d), e.strokeText(n.text, a, u)), f && (en(e, "fillStyle", f), e.fillText(
			n.text, a, u))
	}
	...
	function Qe(t, e, n, i, r, o, a) {
		var s = n.textBackgroundColor,
			...
			h = n.textBorderColor,
			u = _(s);
		if (en(e, "shadowBlur", n.textBoxShadowBlur || 0), en(e, "shadowColor", n.textBoxShadowColor || "transparent"), en(e,
				"shadowOffsetX", n.textBoxShadowOffsetX || 0), en(e, "shadowOffsetY", n.textBoxShadowOffsetY || 0), u || l && h) {
			e.beginPath();
	...
	function tn(t, e, n) {
		...
		if (n) {
			...
			if (s instanceof Array) i = n.x + on(s[0], n.width), r = n.y + on(s[1], n.height);
			else {
	...
	function dn(t, e, n) {
		return Em.copy(t.getBoundingRect()), t.transform && Em.applyTransform(t.transform), Nm.width = e, Nm.height = n, !Em
			.intersect(Nm)
	}
	...
	function _n(t) {
		...
		xg.call(this), this.dom = t, this._touching = !1, this._touchTimer, this._handlers = {}, xn(this), Kp.pointerEventsSupported ?
			e(Wm, this) : (Kp.touchEventsSupported && e(Vm, this), e(Fm, this))
	}
	...
	function Dn(t) {
		...
		$m(t, function(t, n) {
			...
			var i = t.exist,
				...
				o = t.keyInfo;
			if (Km(r)) {
				if (o.name = null != r.name ? r.name + "" : i ? i.name : Jm + n, i) o.id = i.id;
	...
	function Hn(t, e) {
		t.$constructor = t, t.extend = function(t) {
			...
			return o(n.prototype, t), n.extend = this.extend, n.superCall = Gn, n.superApply = Zn, h(n, this), n.superClass =
				e, n
		}
	}
	...
	function Un(t, e) {
		...
		if (t.registerClass = function(t, e) {
				...
				var r = i[t];
				if (r && r[iv] && (r = e ? r[e] : null), n && !r) throw new Error(e ? "Component " + t + "." + (e || "") +
	...
	function $n(t, e, n, i, r, o) {
		var a = i + 3 * (e - n) - t,
			...
			d = l * l - 3 * s * h,
			f = 0;
		if (Xn(u) && Xn(c)) Xn(s) ? o[0] = 0 : (M = -l / s) >= 0 && M <= 1 && (o[f++] = M);
		else {
			var p = c * c - 4 * u * d;
			if (Xn(p)) {
				var g = c / u,
				...
				var v = cv(p),
					y = u * s + 1.5 * a * (-c + v),
					x = u * s + 1.5 * a * (-c - v);
				(M = (-s - ((y = y < 0 ? -uv(-y, gv) : uv(y, gv)) + (x = x < 0 ? -uv(-x, gv) : uv(x, gv)))) / (3 * a)) >= 0 && M <=
					1 && (o[f++] = M)
			} else {
	...
	function Jn(t, e, n, i, r, o, a, s, l, h, u) {
		var c, d, f, p, g, m = .005,
			v = 1 / 0;
		mv[0] = l, mv[1] = h;
		for (var y = 0; y < 1; y += .05) vv[0] = jn(t, n, r, a, y), vv[1] = jn(e, i, o, s, y), (p = mg(mv, vv)) < v && (c =
			y, v = p);
		v = 1 / 0;
		for (var x = 0; x < 32 && !(m < fv); x++) d = c - m, f = c + m, vv[0] = jn(t, n, r, a, d), vv[1] = jn(e, i, o, s, d),
			p = mg(vv, mv), d >= 0 && p < v ? (c = d, v = p) : (yv[0] = jn(t, n, r, a, f), yv[1] = jn(e, i, o, s, f), g = mg(yv,
				mv), f <= 1 && g < v ? (c = f, v = g) : m *= .5);
	...
	function oi(t, e, n, i, r, o, a, s, l) {
		var h, u = .005,
			c = 1 / 0;
		mv[0] = a, mv[1] = s;
		for (var d = 0; d < 1; d += .05) vv[0] = ti(t, n, r, d), vv[1] = ti(e, i, o, d), (m = mg(mv, vv)) < c && (h = d, c =
			m);
		c = 1 / 0;
	...
	function li(t, e, n, i, r, o, a, s, l, h) {
		...
		l[0] = xv(t, l[0]), h[0] = _v(t, h[0]), l[0] = xv(a, l[0]), h[0] = _v(a, h[0]), l[1] = xv(e, l[1]), h[1] = _v(e, h[1]),
			l[1] = xv(s, l[1]), h[1] = _v(s, h[1])
	}
	...
	function ui(t, e, n, i, r, o, a, s, l) {
		...
		if (Mv[0] = bv(r) * n + t, Mv[1] = wv(r) * i + e, Iv[0] = bv(o) * n + t, Iv[1] = wv(o) * i + e, h(s, Mv, Iv), u(l,
				Mv, Iv), (r %= Sv) < 0 && (r += Sv), (o %= Sv) < 0 && (o += Sv), r > o && !a ? o += Sv : r < o && a && (r += Sv),
			a) {
			var d = o;
			o = r, r = d
		}
		for (var f = 0; f < o; f += Math.PI / 2) f > r && (Tv[0] = bv(f) * n + t, Tv[1] = wv(f) * i + e, h(s, Tv, s), u(l,
			Tv, l))
	}
	...
	function di(t, e, n, i, r, o, a, s, l, h, u) {
		if (0 === l) return !1;
		var c = l;
		return !(u > e + c && u > i + c && u > o + c && u > s + c || u < e - c && u < i - c && u < o - c && u < s - c || h >
			t + c && h > n + c && h > r + c && h > a + c || h < t - c && h < n - c && h < r - c && h < a - c) && Jn(t, e, n, i,
			r, o, a, s, h, u, null) <= c / 2
	}

	function fi(t, e, n, i, r, o, a, s, l) {
		if (0 === a) return !1;
		var h = a;
		return !(l > e + h && l > i + h && l > o + h || l < e - h && l < i - h && l < o - h || s > t + h && s > n + h && s >
			r + h || s < t - h && s < n - h && s < r - h) && oi(t, e, n, i, r, o, s, l, null) <= h / 2
	}
	...
	function xi(t, e, n, i, r, o, a, s, l, h) {
		...
		for (var c, d, f = 0, p = -1, g = 0; g < u; g++) {
			var m = Yv[g],
				v = 0 === m || 1 === m ? .5 : 1;
			jn(t, n, r, a, m) < l || (p < 0 && (p = Kn(e, i, o, s, jv), jv[1] < jv[0] && p > 1 && yi(), c = jn(e, i, o, s, jv[0]),
					p > 1 && (d = jn(e, i, o, s, jv[1]))), 2 === p ? m < jv[0] ? f += c < e ? v : -v : m < jv[1] ? f += d < c ? v :
				-v : f += s < d ? v : -v : m < jv[0] ? f += c < e ? v : -v : f += s < c ? v : -v)
		}
		return f
	}
		...
		for (var u = 0, c = 0; c < 2; c++) {
			...
			if (d + t > a) {
				var f = Math.atan2(s, d),
					p = o ? 1 : -1;
				f < 0 && (f = Uv + f), (f >= i && f <= r || f + Uv >= i && f + Uv <= r) && (f > Math.PI / 2 && f < 1.5 * Math.PI &&
					(p = -p), u += p)
			}
		}
		return u
	...
	function Ti(t, e, n, i, r, o, a, s, l, h, u) {
		var c = l * (ay / 180),
			...
			p = d * d / (a * a) + f * f / (s * s);
		p > 1 && (a *= iy(p), s *= iy(p));
		var g = (r === o ? -1 : 1) * iy((a * a * (s * s) - a * a * (f * f) - s * s * (d * d)) / (a * a * (f * f) + s * s * (
				d * d))) || 0,
			m = g * a * f / s,
			v = g * -s * d / a,
			...
			b = [(-1 * d - m) / a, (-1 * f - v) / s],
			S = hy(w, b);
		ly(w, b) <= -1 && (S = ay), ly(w, b) >= 1 && (S = 0), 0 === o && S > 0 && (S -= 2 * ay), 1 === o && S < 0 && (S += 2 *
			ay), u.addData(h, y, x, a, s, _, S, c, o)
	}

	function Ai(t) {
		if (!t) return new Hv;
		for (var e, n = 0, i = 0, r = n, o = i, a = new Hv, s = Hv.CMD, l = t.match(uy), h = 0; h < l.length; h++) {
			for (var u, c = l[h], d = c.charAt(0), f = c.match(cy) || [], p = f.length, g = 0; g < p; g++) f[g] = parseFloat(f[
				g]);
			for (var m = 0; m < p;) {
				...
				switch (d) {
					...
					case "C":
						...
						break;
					case "c":
						u = s.C, a.addData(u, f[m++] + n, f[m++] + i, f[m++] + n, f[m++] + i, f[m++] + n, f[m++] + i), n += f[m - 2], i +=
							f[m - 1];
						break;
					case "S":
						v = n, y = i;
						var T = a.len(),
							A = a.data;
						e === s.C && (v += n - A[T - 4], y += i - A[T - 3]), u = s.C, M = f[m++], I = f[m++], n = f[m++], i = f[m++], a.addData(
							u, v, y, M, I, n, i);
						break;
					case "s":
						v = n, y = i;
						var T = a.len(),
							A = a.data;
						e === s.C && (v += n - A[T - 4], y += i - A[T - 3]), u = s.C, M = n + f[m++], I = i + f[m++], n += f[m++], i +=
							f[m++], a.addData(u, v, y, M, I, n, i);
						break;
					case "Q":
	...
	function Oi(t, e, n) {
		...
		if (e && i) {
			var r = e.x1,
				...
				a = e.y1,
				s = e.y2;
			by(2 * r) === by(2 * o) ? t.x1 = t.x2 = Ei(r, i, !0) : (t.x1 = r, t.x2 = o), by(2 * a) === by(2 * s) ? t.y1 = t.y2 =
				Ei(a, i, !0) : (t.y1 = a, t.y2 = s)
		}
	}
	...
	function zi(t, e, n) {
		...
		if (e && i) {
			var r = e.x,
				...
				a = e.width,
				s = e.height;
			t.x = Ei(r, i, !0), t.y = Ei(o, i, !0), t.width = Math.max(Ei(r + a, i, !1) - t.x, 0 === a ? 0 : 1), t.height =
				Math.max(Ei(o + s, i, !1) - t.y, 0 === s ? 0 : 1)
		}
	}
	...
	function Gi(t) {
		var e = t.shape,
			n = t.style.lineWidth;
		return Ey(2 * e.x1) === Ey(2 * e.x2) && (e.x1 = e.x2 = Ui(e.x1, n, !0)), Ey(2 * e.y1) === Ey(2 * e.y2) && (e.y1 = e.y2 =
			Ui(e.y1, n, !0)), t
	}
	...
	function Zi(t) {
		var e = t.shape,
			...
			o = e.width,
			a = e.height;
		return e.x = Ui(e.x, n, !0), e.y = Ui(e.y, n, !0), e.width = Math.max(Ui(i + o, n, !1) - e.x, 0 === o ? 0 : 1), e.height =
			Math.max(Ui(r + a, n, !1) - e.y, 0 === a ? 0 : 1), t
	}
	...
	function qi(t) {
		...
		if (e && !t.__highlighted) {
			...
			if (i || !n) {
				var r = t,
					o = t.style;
				n && (o = (r = i.addHover(t)).style), pr(o), n || ji(r), o.extendFrom(e), $i(o, e, "fill"), $i(o, e, "stroke"), fr(
					o), n || (t.dirty(!1), t.z2 += Fy)
			}
		}
	}
	...
	function Ji(t, e) {
		e = t.__hoverStl = !1 !== e && (e || {}), t.__hoverStlDirty = !0, t.__highlighted && (t.__cachedNormalStl = null, Ki(
			t), qi(t))
	}
	...
	function sr(t, e, n, i, r, o, a) {
		var s, l = (r = r || By).labelFetcher,
			h = r.labelDataIndex,
			u = r.labelDimIndex,
			c = n.getShallow("show"),
			d = i.getShallow("show");
		(c || d) && (l && (s = l.getFormattedLabel(h, "normal", null, u)), null == s && (s = x(r.defaultText) ? r.defaultText(
			h, r) : r.defaultText));
		var f = c ? s : null,
	...
	function cr(t, e, n, i, r, o) {
		n = !r && n || By, t.textFill = dr(e.getShallow("color"), i) || n.color, t.textStroke = dr(e.getShallow(
				"textBorderColor"), i) || n.textBorderColor, t.textStrokeWidth = A(e.getShallow("textBorderWidth"), n.textBorderWidth),
			t.insideRawTextPosition = t.textPosition, r || (o && (t.insideRollbackOpt = i, fr(t)), null == t.textFill && (t.textFill =
			...
			t.textLineHeight = e.getShallow("lineHeight"), t.textWidth = e.getShallow("width"), t.textHeight = e.getShallow(
				"height"), t.textTag = e.getShallow("tag"), o && i.disableBox || (t.textBackgroundColor = dr(e.getShallow(
				"backgroundColor"), i), t.textPadding = e.getShallow("padding"), t.textBorderColor = dr(e.getShallow(
	...
	function mr(t, e, n, i, r, o) {
		if ("function" == typeof r && (o = r, r = null), i && i.isAnimationEnabled()) {
			...
			"function" == typeof h && (h = h(r, i.getAnimationDelayParams ? i.getAnimationDelayParams(e, r) : null)),
				"function" == typeof s && (s = s(r)), s > 0 ? e.animateTo(n, s, h || 0, l, o, !!o) : (e.stopAnimation(), e.attr(n),
					o && o())
	...
	function Mr(t, e, n) {
		...
		if (n = n || {
				...
				width: 2,
				height: 2
			}, t) return 0 === t.indexOf("image://") ? (i.image = t.slice(8), a(i, n), new hn(e)) : Fi(t.replace("path://", ""),
			e, n, "center")
	}
	...
	function $r(t, e, n) {
		...
		return t = t.replace("MM", qr(a, 2)).replace("M", a).replace("yyyy", o).replace("yy", o % 100).replace("dd", qr(s, 2))
			.replace("d", s).replace("hh", qr(l, 2)).replace("h", l).replace("mm", qr(h, 2)).replace("m", h).replace("ss", qr(u,
				2)).replace("s", u).replace("SSS", qr(c, 3))
	}
	...
	function Jr(t, e, n) {
		...
		var i = e.width,
			...
			d = n[1] + n[3],
			f = t.aspect;
		switch (isNaN(h) && (h = i - s - d - o), isNaN(u) && (u = r - l - c - a), null != f && (isNaN(h) && isNaN(u) && (f >
			i / r ? h = .8 * i : u = .8 * r), isNaN(h) && (h = f * u), isNaN(u) && (u = h / f)), isNaN(o) && (o = i - s - h -
			d), isNaN(a) && (a = r - l - u - c), t.left || t.right) {
			case "center":
				o = i / 2 - h / 2 - n[3];
				break;
			case "right":
	...
	function to(t, e, n, i, r) {
		...
		if (o || s) {
			var h;
			if ("raw" === l) h = "group" === t.type ? new se(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect();
	...
	function so(t) {
		this.fromDataset = t.fromDataset, this.data = t.data || (t.sourceFormat === Sx ? {} : []), this.sourceFormat = t.sourceFormat ||
			Mx, this.seriesLayoutBy = t.seriesLayoutBy || Tx, this.dimensionsDefine = t.dimensionsDefine, this.encodeDefine = t
	...
	function co(t) {
		...
		if (l) {
			var h = l.option;
			n = h.source, i = Cx(l).sourceFormat, r = !0, o = o || h.seriesLayoutBy, null == a && (a = h.sourceHeader), s = s ||
				h.dimensions
		}
		var u = fo(n, i, o, a, s),
			c = e.encode;
	...
	function fo(t, e, n, i, r) {
		...
		else if (e === bx) r || (r = mo(t), s = !0);
		else if (e === Sx) r || (r = [], s = !0, d(t, function(t, e) {
			r.push(e)
		}));
		else if (e === xx) {
			var l = Tn(t[0]);
	...
	function bo(t, e) {
		...
		d(e, function(e, o) {
			"colorLayer" === o && r || fx.hasClass(o) || ("object" == typeof e ? t[o] = t[o] ? i(t[o], e, !1) : n(e) : null ==
				t[o] && (t[o] = e))
		})
	}
	...
	function Bo(t) {
		Ro(t, "itemStyle"), Ro(t, "lineStyle"), Ro(t, "areaStyle"), Ro(t, "label"), Ro(t, "labelLine"), Ro(t, "upperLabel"),
			Ro(t, "edgeLabel")
	}
	...
	function Ho(t) {
		if (Fx(t)) {
			No(t), Bo(t), Fo(t, "label"), Fo(t, "upperLabel"), Fo(t, "edgeLabel"), t.emphasis && (Fo(t.emphasis, "label"), Fo(t
				.emphasis, "upperLabel"), Fo(t.emphasis, "edgeLabel"));
			var e = t.markPoint;
			e && (No(e), Vo(e));
			var n = t.markLine;
			n && (No(n), Vo(n));
			...
			if ("graph" === t.type) {
				...
				if (o && !S(o))
					for (s = 0; s < o.length; s++) Vo(o[s]);
				d(t.categories, function(t) {
					Bo(t)
				})
			}
			if (r && !S(r))
				for (s = 0; s < r.length; s++) Vo(r[s]);
			if ((e = t.markPoint) && e.data)
				for (var a = e.data, s = 0; s < a.length; s++) Vo(a[s]);
			if ((n = t.markLine) && n.data)
				for (var l = n.data, s = 0; s < l.length; s++) y(l[s]) ? (Vo(l[s][0]), Vo(l[s][1])) : Vo(l[s]);
			"gauge" === t.type ? (Fo(t, "axisLabel"), Fo(t, "title"), Fo(t, "detail")) : "treemap" === t.type ? (Ro(t.breadcrumb,
	...
	function jo(t, e) {
		...
		var n = this._data = t.data,
			i = t.sourceFormat;
		i === Ix && (this._offset = 0, this._dimSize = e, this._data = n), o(this, Xx[i === _x ? i + "_" + t.seriesLayoutBy :
			i])
	}
	...
	function ta(t, e) {
		...
		return "time" === n && "number" != typeof t && null != t && "-" !== t && (t = +Vr(t)), null == t || "" === t ? NaN :
			+t
	}
	...
	function ma(t, e) {
		if (t && (t.trigger(e), "group" === t.type))
			for (var n = 0; n < t.childCount(); n++) ma(t.childAt(n), e)
	}
	...
	function Ga(t, e, n, i) {
		...
		var c = e.style;
		null != r.fill && c.set(h, Za(r.fill, n)), null != r.stroke && c.set(u, Za(r.stroke, n)), d(["lineWidth", "opacity",
			...
			}), r.lineDash && (e.style.lineDash = L(r.lineDash).split(T_)), c[u] && "none" !== c[u] && (e[u] = !0), e.__inheritedStyle =
			r
	}
	...
	function $a(t, e, i) {
		...
		this._throttledZrFlush = _a(m(o.flush, o), 17), (e = n(e)) && Zx(e, !0), this._theme = e, this._chartsViews = [],
			this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._coordSysMgr = new Do;
		var a = this._api = ps(this);
		ge(iw, r), ge(tw, r), this._scheduler = new Sa(this, a, tw, iw), xg.call(this, this._ecEventProcessor = new gs),
			this._messageCenter = new qa, this._initEvents(), this.resize = m(this.resize, this), this._pendingActions = [], o.animation
			.on("frame", this._onframe, this), rs(o, this), O(this)
	}
	...
	function es(t, e) {
		...
		R_(u, function(t) {
			d = r.action(t, this._model, this._api), (d = d || o({}, t)).type = s.event || d.type, p.push(d), g ? Ja(this, h,
				t, "series") : l && Ja(this, h, t, l.main, l.sub)
		}, this), "none" === h || g || l || (this[Y_] ? (Qa(this), $_.update.call(this, t), this[Y_] = !1) : $_[h].call(
			this, t)), d = c ? {
			type: s.event || n,
			escapeConnect: i,
			batch: p
	...
	function rs(t, e) {
		t.on("rendered", function() {
			e.trigger("rendered"), !t.animation.isFinished() || e[Y_] || e._scheduler.unfinished || e._pendingActions.length ||
				e.trigger("finished")
		})
	}
	...
	function os(t, e, n, i) {
		...
		for (var o = "component" === e, a = o ? t._componentsViews : t._chartsViews, s = o ? t._componentsMap : t._chartsMap,
				l = t._zr, h = t._api, u = 0; u < a.length; u++) a[u].__alive = !1;
		o ? n.eachComponent(function(t, e) {
			"series" !== t && r(e)
		}) : n.eachSeries(r);
		for (u = 0; u < a.length;) {
			var c = a[u];
			c.__alive ? u++ : (!o && c.renderTask.dispose(), l.remove(c.group), c.dispose(n, h), a.splice(u, 1), delete s[c.__id],
	...
	function zs(t) {
		...
		d(t.dimensions, function(e) {
			...
			if (s) {
				var l = n[s];
				n.hasOwnProperty(s) || (l = n[s] = []), l[a.coordDimIndex] = e, a.isExtraCoord || (i.set(s, 1), Ns(a.type) && (r[
	...
	function $s(t, e, i) {
		...
		for (var s = (i.dimsDef || []).slice(), l = N(i.encodeDef), h = N(), u = N(), c = [], f = Ks(e, t, s, i.dimCount), p =
				0; p < f; p++) {
		...
		d(t, function(t, e) {
			...
			if (_(t)) i = t, t = {};
				...
				i = t.name;
				var h = t.ordinalMeta;
				t.ordinalMeta = null, (t = n(t)).ordinalMeta = h, o = t.dimsDef, s = t.otherDims, t.name = t.coordDim = t.coordDimIndex =
		...
		var x = i.generateCoord,
			...
			S = null != b;
		b = x ? b || 1 : 0;
		for (var M = x || "value", I = 0; I < f; I++) null == (v = c[I] = c[I] || {}).coordDim && (v.coordDim = Qs(M, u, S),
				v.coordDimIndex = 0, (!x || b <= 0) && (v.isExtraCoord = !0), b--), null == v.name && (v.name = Qs(v.coordDim, h)),
			null == v.type && xo(e, I, v.name) && (v.type = "ordinal");
		return c
	}
	...
	function dl(t, e) {
		!isFinite(t[0]) && (t[0] = e[0]), !isFinite(t[1]) && (t[1] = e[1]), cl(t, 0, e), cl(t, 1, e), t[0] > t[1] && (t[0] =
			t[1])
	}
	...
	function Ml(t, e) {
		...
		"ordinal" === o ? n = e.getCategories().length : (y(i = e.get("boundaryGap")) || (i = [i || 0, i || 0]), "boolean" ==
				typeof i[0] && (i = [0, 0]), i[0] = Pr(i[0], 1), i[1] = Pr(i[1], 1), r = u[1] - u[0] || Math.abs(u[0])), null == a &&
			(a = "ordinal" === o ? n ? 0 : NaN : u[0] - i[0] * r), null == s && (s = "ordinal" === o ? n ? n - 1 : NaN : u[1] +
				i[1] * r), "dataMin" === a ? a = u[0] : "function" == typeof a && (a = a({
				min: u[0],
				max: u[1]
	...
	function Nl(t, e, n, i, r, o, a) {
		...
		var l;
		return l = 0 === t.indexOf("image://") ? Vi(t.slice(8), new se(e, n, i, r), a ? "center" : "cover") : 0 === t.indexOf(
			"path://") ? Fi(t.slice(7), {}, new se(e, n, i, r), a ? "center" : "cover") : new rb({
			shape: {
				symbolType: t,
				x: e,
				y: n,
	...
	function Vl(t) {
		...
		for (var n = t.features, i = 0; i < n.length; i++)
			for (var r = n[i].geometry, o = r.coordinates, a = r.encodeOffsets, s = 0; s < o.length; s++) {
				var l = o[s];
				if ("Polygon" === r.type) o[s] = Hl(l, a[s], e);
	...
	function Xl(t, e) {
		...
		if (r) return r;
		var o, a;
		if (e.get("show") && !t.scale.isBlank() || (o = []), x(i)) o = eh(t, i, !0);
		else if ("auto" === i) {
	...
	function Ql(t) {
		...
		for (var l = o[0], h = t.dataToCoord(l + 1) - t.dataToCoord(l), u = Math.abs(h * Math.cos(i)), c = Math.abs(h * Math
	...
	function Sh(t, e, n, i, r, o, a, s, l, h, u) {
		for (var c = 0, d = n, f = 0; f < i; f++) {
			...
			if (d === n) t[o > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Tb(Cb, p);
			else if (l > 0) {
				var g = d + o,
					m = e[g];
				if (u)
					for (; m && _h(e[g]);) m = e[g += o];
				var v = .5,
					y = e[c];
				if (!(m = e[g]) || _h(m)) Tb(Db, p);
				else {
					_h(m) && !u && (m = p), G(Ab, m, y);
					var x, _;
					if ("x" === h || "y" === h) {
				...
				Sb(Cb, Cb, s), Mb(Cb, Cb, a), Sb(Db, Db, s), Mb(Db, Db, a), t.bezierCurveTo(Cb[0], Cb[1], Db[0], Db[1], p[0], p[1]),
					Ib(Cb, p, Ab, l * v)
			} else t.lineTo(p[0], p[1]);
			c = d, d += o
		}
	...
	function Eh(t, e) {
		...
		for (var r = e.count(), o = Math.max(1, Math.round(r / 5)), a = 0; a < r; a += o)
			if (1.5 * oh.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > i) return !1;
		return !0
	}
	...
	function Yh(t, e, n, i) {
		var r, o, a = Br(n - t.rotation),
			s = i[0] > i[1],
			l = "start" === e && !s || "start" !== e && s;
		return Fr(a - Xb / 2) ? (o = l ? "bottom" : "top", r = "center") : Fr(a - 1.5 * Xb) ? (o = l ? "top" : "bottom", r =
			"center") : (o = "middle", r = a < 1.5 * Xb && a > Xb / 2 ? l ? "left" : "right" : l ? "right" : "left"), {
			rotation: a,
			textAlign: r,
			textVerticalAlign: o
		}
	...
	function qh(t, e, n) {
		if (!zl(t.axis)) {
			...
			var o = e[0],
				...
				c = n[n.length - 1],
				d = n[n.length - 2];
			!1 === i ? ($h(o), $h(h)) : Kh(o, a) && (i ? ($h(a), $h(u)) : ($h(o), $h(h))), !1 === r ? ($h(s), $h(c)) : Kh(l, s) &&
				(r ? ($h(l), $h(d)) : ($h(s), $h(c)))
		}
	}
	...
	function Kh(t, e, n) {
		...
		if (i && r) {
			var o = vt([]);
			return wt(o, o, -t.rotation), i.applyTransform(xt([], o, t.getLocalTransform())), r.applyTransform(xt([], o, e.getLocalTransform())),
				i.intersect(r)
		}
	}
	...
	function Jh(t, e, n) {
		...
		if (e.get("axisTick.show") && !i.scale.isBlank()) {
			for (var r = e.getModel("axisTick"), o = r.getModel("lineStyle"), s = r.get("length"), l = i.getTicksCoords(), h = [],
		...
		if (T(n.axisLabelShow, e.get("axisLabel.show")) && !i.scale.isBlank()) {
			...
			return d(a, function(a, s) {
				...
				lr(x.style, m, {
					...
					}), f && (x.eventData = Xh(e), x.eventData.targetType = "axisLabel", x.eventData.value = g), t._dumbGroup.add(x),
					x.updateTransform(), u.push(x), t.group.add(x), x.decomposeTransform()
			}), u
		}
	}
	...
	function iu(t, e, i, r, o, s) {
		var l = e.getModel("axisPointer"),
			h = {};
		$b(["type", "snap", "lineStyle", "shadowStyle", "label", "animation", "animationDurationUpdate",
	...
	function ru(t, e) {
		e.eachSeries(function(e) {
			...
			n && "none" !== i && !1 !== i && "item" !== i && !1 !== r && !1 !== e.get("axisPointer.show", !0) && $b(t.coordSysAxesInfo[
				cu(n.model)], function(t) {
				var i = t.axis;
	...
	function Nu(t, e) {
		t && (t.hv = e.hv = [Ou(e, ["left", "right"]), Ou(e, ["top", "bottom"])], "group" === t.type && (null == t.width &&
		...
		if (!a.scale.isBlank() && a.containData(e))
			if (t.involveSeries) {
				var s = Fu(e, t),
					l = s.payloadBatch,
					h = s.snapToValue;
				l[0] && null == r.seriesIndex && o(r, l[0]), !i && t.snap && a.containData(h) && null != h && (e = h), n.showPointer(
					t, e, l, r), n.showTooltip(t, s, h)
	...
	function qu(t, e) {
		...
		SS(t).initialized || (SS(t).initialized = !0, n("click", v(Qu, "click")), n("mousemove", v(Qu, "mousemove")), n(
			"globalout", Ku))
	}
	...
	function cc(t, e, n) {
		var i = mt();
		return wt(i, i, n.rotation), _t(i, i, n.position), _r([t.dataToCoord(e), (n.labelOffset || 0) + (n.labelDirection ||
			1) * (n.labelMargin || 0)], i)
	}
	...
	function yc(t) {
		...
		return i && e.push("color:" + i), e.push("font:" + t.getFont()), n && e.push("line-height:" + Math.round(3 * n / 2) +
			"px"), PS(["decoration", "align"], function(n) {
			var i = t.get(n);
			i && e.push("text-" + n + ":" + i)
		}), e.join(";")
	}
	...
	function xc(t) {
		var e = [],
			...
			o = t.get("padding");
		return n && e.push(vc(n)), i && (Kp.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" +
			Vt(i)), e.push("filter:alpha(opacity=70)"))), PS(["width", "color", "radius"], function(n) {
			var i = "border-" + n,
				r = LS(i),
				o = t.get(r);
	...
	function Vc(t, e, n, i) {
		...
		return null != t.valueIndex || null != t.valueDim ? (r.valueDataDim = null != t.valueIndex ? e.getDimension(t.valueIndex) :
			t.valueDim, r.valueAxis = n.getAxis(Hc(i, r.valueDataDim)), r.baseAxis = n.getOtherAxis(r.valueAxis), r.baseDataDim =
	...
	function ed(t, e, n, i, r, o) {
		...
		rd(n.getItemLayout(r)) ? (a ? a.updateData(n, r, o) : a = new t._ctor(n, r, o), n.setItemGraphicEl(r, a), t.group.add(
			a)) : t.group.remove(a)
	}
		...
		if (isNaN(l) || isNaN(h)) {
			...
			if ("cartesian2d" === a.type) {
				var f = a.getAxis("x"),
					p = a.getAxis("y"),
					u = a.dimensions;
				od(t.get(u[0], e)) ? o[0] = f.toGlobalCoord(f.getExtent()[n ? 0 : 1]) : od(t.get(u[1], e)) && (o[1] = p.toGlobalCoord(
					p.getExtent()[n ? 0 : 1]))
			}
		...
		if (isNaN(l) || isNaN(h)) {
			...
			if ("cartesian2d" === a.type) {
				var c = a.getAxis("x"),
					...
					f = t.get(n[0], e),
					p = t.get(n[1], e);
				ud(f) ? o[0] = c.toGlobalCoord(c.getExtent()["x0" === n[0] ? 0 : 1]) : ud(p) && (o[1] = d.toGlobalCoord(d.getExtent()[
					"y0" === n[1] ? 0 : 1]))
			}
			isNaN(l) || (o[0] = l), isNaN(h) || (o[1] = h)
		} else o = [l, h];
	...
	function Vd(t, e) {
		...
		o.controller.enable(a.controlType, a.opt), o.controller.setPointerChecker(e.containsPoint), wa(o, "dispatchAction",
	...
	function df(t) {
		xg.call(this), this._zr = t, this.group = new am, this._brushType, this._brushOption, this._panels, this._track = [],
			this._dragging, this._covers = [], this._creatingCover, this._creatingPanel, this._enableGlobalPan, this._uid =
			"brushController_" + oI++, this._handlers = {}, YM(aI, function(t, e) {
	...
	function Cf(t, e, n, i) {
		var r = i.brushStyle.lineWidth || 0,
			...
			m = p + r,
			v = g + r;
		kf(t, e, "main", a, s, p, g), i.transformable && (kf(t, e, "w", l, h, o, v), kf(t, e, "e", d, h, o, v), kf(t, e, "n",
			l, h, m, o), kf(t, e, "s", l, f, m, o), kf(t, e, "nw", l, h, o, o), kf(t, e, "ne", d, h, o, o), kf(t, e, "sw", l,
			f, o, o), kf(t, e, "se", d, f, o, o))
	}
	...
	function zf(t, e) {
		if (e.length > 1) return ("e" === (i = [zf(t, (e = e.split(""))[0]), zf(t, e[1])])[0] || "w" === i[0]) && i.reverse(),
			i.join("");
		var n = {
				left: "w",
				right: "e",
	...
	function Gf(t, e, i, r) {
		...
		if (t._track.push(i.slice()), If(t) || a) {
			if (s && !a) {
				...
				var h = n(l);
				h.brushType = Zf(h.brushType, s), h.panelId = !0 === s ? null : s.panelId, a = t._creatingCover = gf(t, h), t._covers
					.push(a)
			}
			if (a) {
	...
	function mp() {
		if (!PI && LI) {
			...
			t.length < 31 ? LI.createStyleSheet().addRule(".zrvml", "behavior:url(#default#VML)") : t[0].addRule(".zrvml",
	...
	function Cp(t, e, n, i) {
		if (Sp(e, n)) {
			...
			r = "transparent" === r ? gT : r, "none" !== t.getAttribute("clip-path") && r === gT && (r = "rgba(0, 0, 0, 0.002)"),
				Tp(t, "fill", r), Tp(t, "fill-opacity", null != e.fillOpacity ? e.fillOpacity * e.opacity : e.opacity)
		} else Tp(t, "fill", gT);
		if (Mp(e, n)) {
			var o = n ? e.textStroke : e.stroke;
			Tp(t, "stroke", o = "transparent" === o ? gT : o), Tp(t, "stroke-width", (n ? e.textStrokeWidth : e.lineWidth) / (!
					n && e.strokeNoScale ? i.getLineScale() : 1)), Tp(t, "paint-order", n ? "stroke" : "fill"), Tp(t,
					"stroke-opacity", null != e.strokeOpacity ? e.strokeOpacity : e.opacity), e.lineDash ? (Tp(t, "stroke-dasharray",
					e.lineDash.join(",")), Tp(t, "stroke-dashoffset", mT(e.lineDashOffset || 0))) : Tp(t, "stroke-dasharray", ""), e.lineCap &&
				Tp(t, "stroke-linecap", e.lineCap), e.lineJoin && Tp(t, "stroke-linejoin", e.lineJoin), e.miterLimit && Tp(t,
	...
	var Tg = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
		Ag = function(t, e, n, i) {
			xg.call(this), this.storage = t, this.painter = e, this.painterRoot = i, n = n || new pt, this.proxy = null, this._hovered = {},
				this._lastTouchMoment, this._lastX, this._lastY, this._gestureMgr, J.call(this), this.setHandlerProxy(n)
		};
	Ag.prototype = {
		constructor: Ag,
		...
		dispatchToElement: function(t, e, n) {
			var i = (t = t || {}).target;
			if (!i || !i.silent) {
				for (var r = "on" + e, o = dt(e, t, n); i && (i[r] && (o.cancelBubble = i[r].call(i, o)), i.trigger(e, o), i = i
	...
	Og.updateTransform = function() {
		var t = this.parent,
			...
			i = this.transform;
		if (n || e) {
			i = i || mt(), n ? this.getLocalTransform(i) : kg(i), e && (n ? xt(i, t.transform, i) : yt(i, t.transform)), this.transform =
				i;
	...
	Og.setLocalTransform = function(t) {
		if (t) {
			var e = t[0] * t[0] + t[1] * t[1],
				...
				i = this.position,
				r = this.scale;
			Mt(e - 1) && (e = Math.sqrt(e)), Mt(n - 1) && (n = Math.sqrt(n)), t[0] < 0 && (e = -e), t[3] < 0 && (n = -n), i[0] =
		...
		if (this.transform) {
			...
			var n = this.origin;
			n && (n[0] || n[1]) && (Ng[4] = n[0], Ng[5] = n[1], xt(Eg, e, Ng), Eg[4] -= n[0], Eg[5] -= n[1], e = Eg), this.setLocalTransform(
				e)
		}
		...
		var n = t.origin,
			...
			r = t.rotation || 0,
			o = t.position || [0, 0];
		return n && (e[4] -= n[0], e[5] -= n[1]), bt(e, e, i), r && wt(e, e, r), n && (e[4] += n[0], e[5] += n[1]), e[4] +=
			o[0], e[5] += o[1], e
	};
	var Rg = {
		linear: function(t) {
	...
	var Gg = {
		...
		jg = (Object.freeze || Object)({
			...
			modifyHSL: function(t, e, n, i) {
				if (t = Nt(t)) return t = Bt(t), null != e && (t[0] = At(e)), null != n && (t[1] = kt(n)), null != i && (t[2] =
					kt(i)), Zt(Rt(t), "rgba")
			},
			modifyAlpha: Gt,
			stringify: Zt
		...
		$g = function(t, e, n, i) {
			this._tracks = {}, this._target = t, this._loop = e || !1, this._getter = n || Ut, this._setter = i || Xt, this._clipCount =
	...
	se.prototype = {
		...
		union: function(t) {
			var e = rm(t.x, this.x),
				n = rm(t.y, this.y);
			this.width = om(t.x + t.width, this.x + this.width) - e, this.height = om(t.y + t.height, this.y + this.height) -
				n, this.x = e, this.y = n
		},
			...
			return function(r) {
				if (r) {
					t[0] = n[0] = this.x, t[1] = i[1] = this.y, e[0] = i[0] = this.x + this.width, e[1] = n[1] = this.y + this.height,
						im(t, t, r), im(e, e, r), im(n, n, r), im(i, i, r), this.x = rm(t[0], e[0], n[0], i[0]), this.y = rm(t[1], e[
							1], n[1], i[1]);
	...
	am.prototype = {
		...
		remove: function(t) {
			var e = this.__zr,
				...
				i = this._children,
				r = l(i, t);
			return r < 0 ? this : (i.splice(r, 1), t.parent = null, n && (n.delFromStorage(t), t instanceof am && t.delChildrenFromStorage(
				n)), e && e.refresh(), this)
		},
		removeAll: function() {
			var t, e, n = this._children,
				i = this.__storage;
			for (e = 0; e < n.length; e++) t = n[e], i && (i.delFromStorage(t), t instanceof am && t.delChildrenFromStorage(i)),
				t.parent = null;
	...
	hm.prototype = {
		...
		addRoot: function(t) {
			t.__storage !== this && (t instanceof am && t.addChildrenToStorage(this), this.addToStorage(t), this._roots.push(
				t))
		},
		delRoot: function(t) {
			if (null == t) {
	...
	gm.prototype = {
		...
		getGradient: function(t, e, n) {
			for (var i = ("radial" === e.type ? ye : ve)(t, e, n), r = e.colorStops, o = 0; o < r.length; o++) i.addColorStop(
	...
	var _m = function(t, e, n) {
		...
		var r = i.style;
		r && (i.onselectstart = xe, r["-webkit-user-select"] = "none", r["user-select"] = "none", r["-webkit-touch-callout"] =
	...
	_m.prototype = {
		...
		createBackBuffer: function() {
			var t = this.dpr;
			this.domBack = _e("back-" + this.id, this.painter, t), this.ctxBack = this.domBack.getContext("2d"), 1 !== t &&
		...
		clear: function(t, e) {
			...
			if (a && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(
				...
				e.colorStops ? (h = e.__canvasGradient || gm.getGradient(i, e, {
						...
						width: r,
						height: o
					}), e.__canvasGradient = h) : e.image && (h = xm.prototype.getCanvasPattern.call(e, i)), i.save(), i.fillStyle =
					h || e, i.fillRect(0, 0, r, o), i.restore()
			}
			if (a) {
				var u = this.domBack;
	...
	var wm = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) ||
	...
	zm.prototype = {
		...
		drawRectText: function(t, e) {
			...
			if (null != i && (i += ""), sn(i, n)) {
				...
				n.transformText ? this.setTransform(t) : r && (Om.copy(e), Om.applyTransform(r), e = Om), Ue(this, t, i, n, e,
					fm), t.restore()
			}
		}
	}, ln.prototype = {
	...
	Rm.prototype = {
		...
		_doPaintEl: function(t, e, n, i) {
			var r = e.ctx,
				o = t.transform;
			if ((e.__dirty || n) && !t.invisible && 0 !== t.style.opacity && (!o || o[0] || o[3]) && (!t.culling || !dn(t,
					this._width, this._height))) {
				var a = t.__clipPaths;
				i.prevElClipPaths && !fn(a, i.prevElClipPaths) || (i.prevElClipPaths && (e.ctx.restore(), i.prevElClipPaths =
						null, i.prevEl = null), a && (r.save(), pn(a, r), i.prevElClipPaths = a)), t.beforeBrush && t.beforeBrush(r),
		...
		getLayer: function(t, e) {
			...
			return n || ((n = new _m("zr_" + t, this, this.dpr)).zlevel = t, n.__builtin__ = !0, this._layerConfig[t] && i(n,
		...
		insertLayer: function(t, e) {
			var n = this._layers,
				...
				a = -1,
				s = this._domRoot;
			if (n[t]) tm("ZLevel " + t + " has been used already");
			else if (cn(e)) {
				if (r > 0 && t > i[0]) {
		...
		_updateLayerStatus: function(t) {
			...
			if (this.eachBuiltinLayer(function(t, e) {
				...
				a.incremental ? ((o = this.getLayer(s + .001, this._needsManuallyCompositing)).incremental = !0, i = 1) : o =
					this.getLayer(s + (i > 0 ? .01 : 0), this._needsManuallyCompositing), o.__builtin__ || tm("ZLevel " + s +
	...
	var Bm = function(t) {
		t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function() {}, this._clips = [], this._running = !
			1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, xg.call(this)
	};
	Bm.prototype = {
		constructor: Bm,
		addClip: function(t) {
	...
	var Fm = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
		...
		Gm = {
			...
			touchstart: function(t) {
				(t = at(this.dom, t)).zrByTouch = !0, this._lastTouchMoment = new Date, this.handler.processGesture(this, t,
					"start"), Gm.mousemove.call(this, t), Gm.mousedown.call(this, t), vn(this)
			},
			touchmove: function(t) {
				(t = at(this.dom, t)).zrByTouch = !0, this.handler.processGesture(this, t, "change"), Gm.mousemove.call(this, t),
					vn(this)
			},
			touchend: function(t) {
				(t = at(this.dom, t)).zrByTouch = !0, this.handler.processGesture(this, t, "end"), Gm.mouseup.call(this, t), +new Date -
					this._lastTouchMoment < 300 && Gm.click.call(this, t), vn(this)
			},
	...
	var qm = (Object.freeze || Object)({
		...
		Qm = y,
		Jm = "series\0",
		tv = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "rich", "tag", "color", "textBorderColor",
	...
	Hv.prototype = {
		...
		moveTo: function(t, e) {
			return this.addData(Dv.M, t, e), this._ctx && this._ctx.moveTo(t, e), this._x0 = t, this._y0 = e, this._xi = t,
				this._yi = e, this
		},
		lineTo: function(t, e) {
			var n = Fv(t - this._xi) > this._ux || Fv(e - this._yi) > this._uy || this._len < 5;
			return this.addData(Dv.L, t, e), this._ctx && n && (this._needsDash() ? this._dashedLineTo(t, e) : this._ctx.lineTo(
				t, e)), n && (this._xi = t, this._yi = e), this
		},
		bezierCurveTo: function(t, e, n, i, r, o) {
			return this.addData(Dv.C, t, e, n, i, r, o), this._ctx && (this._needsDash() ? this._dashedBezierTo(t, e, n, i, r,
				o) : this._ctx.bezierCurveTo(t, e, n, i, r, o)), this._xi = r, this._yi = o, this
		},
		quadraticCurveTo: function(t, e, n, i) {
			return this.addData(Dv.Q, t, e, n, i), this._ctx && (this._needsDash() ? this._dashedQuadraticTo(t, e, n, i) :
				this._ctx.quadraticCurveTo(t, e, n, i)), this._xi = n, this._yi = i, this
		},
		arc: function(t, e, n, i, r, o) {
			return this.addData(Dv.A, t, e, n, n, i, r - i, 0, o ? 0 : 1), this._ctx && this._ctx.arc(t, e, n, i, r, o), this
				._xi = Nv(r) * n + t, this._yi = Rv(r) * n + e, this
		},
		...
		_dashedLineTo: function(t, e) {
			var n, i, r = this._dashSum,
				...
				p = h,
				g = a.length;
			for (u /= d, c /= d, o < 0 && (o = r + o), f -= (o %= r) * u, p -= o * c; u > 0 && f <= t || u < 0 && f >= t || 0 ===
				u && (c > 0 && p <= e || c < 0 && p >= e);) f += u * (n = a[i = this._dashIdx]), p += c * n, this._dashIdx = (i +
				1) % g, u > 0 && f < l || u < 0 && f > l || c > 0 && p < h || c < 0 && p > h || s[i % 2 ? "moveTo" : "lineTo"](
				u >= 0 ? zv(f, t) : Ev(f, t), c >= 0 ? zv(p, e) : Ev(p, e));
		...
		_dashedBezierTo: function(t, e, n, i, r, o) {
			...
			for (d < 0 && (d = c + d), d %= c, a = 0; a < 1; a += .1) s = v(g, t, n, r, a + .1) - v(g, t, n, r, a), l = v(m,
				e, i, o, a + .1) - v(m, e, i, o, a), y += Bv(s * s + l * l);
			for (; x < _ && !((w += f[x]) > d); x++);
			for (a = (w - d) / y; a <= 1;) h = v(g, t, n, r, a), u = v(m, e, i, o, a), x % 2 ? p.moveTo(h, u) : p.lineTo(h, u),
				a += f[x] / y, x = (x + 1) % _;
			...
			for (var t = this.data, e = 0, n = 0, i = 0, r = 0, o = 0; o < t.length;) {
				...
				switch (1 === o && (i = e = t[o], r = n = t[o + 1]), a) {
					...
					case Dv.A:
						...
						o += 1;
						var f = 1 - t[o++];
						1 === o && (i = Nv(c) * h + s, r = Rv(c) * u + l), ui(s, l, h, u, c, d, f, Lv, Ov), e = Nv(d) * h + s, n = Rv(
							d) * u + l;
						break;
					case Dv.R:
				...
				switch (1 === c && (e = i = s[c], n = r = s[c + 1]), d) {
					...
					case Dv.A:
						...
						Math.abs(g - m) > .001 ? (t.translate(f, p), t.rotate(x), t.scale(b, S), t.arc(0, 0, w, v, M, 1 - _), t.scale(
							1 / b, 1 / S), t.rotate(-x), t.translate(-f, -p)) : t.arc(f, p, w, v, M, 1 - _), 1 === c && (e = Nv(v) * g +
							f, n = Rv(v) * m + p), i = Nv(M) * g + f, r = Rv(M) * m + p;
						break;
					case Dv.R:
	...
	Ii.prototype = {
		...
		brush: function(t, e) {
			...
			if (n.bind(t, this, e), this.setTransform(t), this.__dirty) {
				var d;
				l && (d = d || this.getBoundingRect(), this._fillGradient = n.getGradient(t, a, d)), h && (d = d || this.getBoundingRect(),
					this._strokeGradient = n.getGradient(t, s, d))
			}
			l ? t.fillStyle = this._fillGradient : u && (t.fillStyle = qv.call(a, t)), h ? t.strokeStyle = this._strokeGradient :
				c && (t.strokeStyle = qv.call(s, t));
			var f = n.lineDash,
				p = n.lineDashOffset,
				g = !!t.setLineDash,
		...
		attrKV: function(t, e) {
			"shape" === t ? (this.setShape(e), this.__dirtyPath = !0, this._rect = null) : ln.prototype.attrKV.call(this, t,
				e)
		},
	...
	dy.prototype = {
		...
		brush: function(t, e) {
			var n = this.style;
			this.__dirty && Ge(n), n.fill = n.stroke = n.shadowBlur = n.shadowColor = n.shadowOffsetX = n.shadowOffsetY =
				null;
			var i = n.text;
			null != i && (i += ""), sn(i, n) ? (this.setTransform(t), Ue(this, t, i, n, null, e), this.restoreTransform(t)) :
				t.__attrCachedBy = dm.NONE
		},
		getBoundingRect: function() {
			var t = this.style;
	...
	var fy = Ii.extend({
		...
		gy = function(t) {
			return Kp.browser.ie && Kp.browser.version >= 11 ? function() {
				...
				if (t.apply(this, arguments), e)
					for (var l = 0; l < py.length; l++) i[py[l][0]] = py[l][2]
			} : t
		},
		my = Ii.extend({
			type: "sector",
			...
			buildPath: function(t, e) {
				var n = e.cx,
					...
					h = Math.cos(a),
					u = Math.sin(a);
				t.moveTo(h * r + n, u * r + i), t.lineTo(h * o + n, u * o + i), t.arc(n, i, o, a, s, !l), t.lineTo(Math.cos(s) *
		...
		My = Ii.extend({
			...
			buildPath: function(t, e) {
				var n, i, r, o;
				this.subPixelOptimize ? (zi(Sy, e, this.style), n = Sy.x, i = Sy.y, r = Sy.width, o = Sy.height, Sy.r = e.r, e =
					Sy) : (n = e.x, i = e.y, r = e.width, o = e.height), e.r ? We(t, e) : t.rect(n, i, r, o), t.closePath()
			}
		}),
		Iy = {},
		Ty = Ii.extend({
			...
			buildPath: function(t, e) {
				var n, i, r, o;
				this.subPixelOptimize ? (Oi(Iy, e, this.style), n = Iy.x1, i = Iy.y1, r = Iy.x2, o = Iy.y2) : (n = e.x1, i = e.y1,
					r = e.x2, o = e.y2);
				var a = e.percent;
		...
		Cy = Ii.extend({
			...
			buildPath: function(t, e) {
				var n = e.x1,
					...
					h = e.cpy2,
					u = e.percent;
				0 !== u && (t.moveTo(n, i), null == l || null == h ? (u < 1 && (ri(n, a, r, u, Ay), a = Ay[1], r = Ay[2], ri(i,
					s, o, u, Ay), s = Ay[1], o = Ay[2]), t.quadraticCurveTo(a, s, r, o)) : (u < 1 && (Qn(n, a, l, r, u, Ay), a =
					Ay[1], l = Ay[2], r = Ay[3], Qn(i, s, h, o, u, Ay), s = Ay[1], h = Ay[2], o = Ay[3]), t.bezierCurveTo(a, s,
					l, h, r, o)))
			},
			pointAt: function(t) {
	...
	var Ly = function(t, e, n, i, r, o) {
		this.x = null == t ? 0 : t, this.y = null == e ? 0 : e, this.x2 = null == n ? 1 : n, this.y2 = null == i ? 0 : i,
			this.type = "linear", this.global = o || !1, Py.call(this, r)
	};
	Ly.prototype = {
		constructor: Ly
	}, h(Ly, Py);
	...
	var Ey = Math.round,
		...
		Zy = {
			...
			getTextRect: function(t) {
				return Te(t, this.getFont(), this.getShallow("align"), this.getShallow("verticalAlign") || this.getShallow(
	...
	var gx = {
		...
		yx = {
			cartesian2d: function(t, e, n, i) {
				...
				e.coordSysDims = ["x", "y"], n.set("x", r), n.set("y", o), ao(r) && (i.set("x", r), e.firstCategoryDimIndex = 0),
					ao(o) && (i.set("y", o), e.firstCategoryDimIndex = 1)
			},
			...
			polar: function(t, e, n, i) {
				...
				e.coordSysDims = ["radius", "angle"], n.set("radius", o), n.set("angle", a), ao(o) && (i.set("radius", o), e.firstCategoryDimIndex =
					0), ao(a) && (i.set("angle", a), e.firstCategoryDimIndex = 1)
			},
	...
	u(kx, vx);
	var Px = ["getDom", "getZr", "getWidth", "getHeight", "getDevicePixelRatio", "dispatchAction", "isDisposed", "on",
	...
	ko.prototype = {
		...
		setOption: function(t, e) {
			...
			this._newBaseOption = i.baseOption, n ? (Eo(n.baseOption, i.baseOption), i.timelineOptions.length && (n.timelineOptions =
		...
		mountOption: function(t) {
			...
			return this._timelineOptions = Ex(e.timelineOptions, zx), this._mediaList = Ex(e.mediaList, zx), this._mediaDefault =
				zx(e.mediaDefault), this._currentMediaIndices = [], zx(t ? e.baseOption : this._newBaseOption)
		},
	...
	var Xx = {
		...
		jx = {
			...
			original: function(t, e, n, i) {
				...
				return !this._rawData.pure && An(t) && (this.hasItemOption = !0), ta(r instanceof Array ? r[i] : r, this._dimensionInfos[
					e])
			},
	...
	Kx.perform = function(t) {
		...
		if (this._dueEnd = n ? n._outputDueEnd : this._count ? this._count(this.context) : 1 / 0, this._progress) {
			...
			if (!i && (u || d < f)) {
				...
				if (y(p))
					for (var g = 0; g < p.length; g++) oa(this, p[g], d, f, l, h);
				else oa(this, p, d, f, l, h)
			}
			this._dueIndex = f;
		...
		t_ = fx.extend({
			...
			mergeDefaultAndTheme: function(t, e) {
				var n = this.layoutMode,
					r = n ? no(t) : {},
					o = this.subType;
				fx.hasClass(o) && (o += "Series"), i(t, e.getTheme().get(this.subType)), i(t, this.getDefaultOption()), In(t,
					"label", ["show"]), this.fillDataTextStyle(t.data), n && eo(t, r, n)
			},
			mergeOption: function(t, e) {
						...
						function r(t, n) {
							...
							if (r && !1 !== r.otherDims.tooltip) {
								var c = r.type,
									...
									m = (a ? g + Xr(r.displayName || "-") + ": " : "") + Xr("ordinal" === c ? t + "" : "time" === c ? e ? "" :
										$r("yyyy/MM/dd hh:mm:ss", t) : Zr(t));
	...
	var w_ = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1",
		...
		b_ = {
			...
			colorLayer: [
				...
				["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], w_
			]
		},
	...
	q_._onframe = function() {
			if (!this._disposed) {
				...
				if (this[Y_]) {
					...
					do {
						var r = +new Date;
						t.performSeriesTasks(i), t.performDataProcessorTasks(i), ts(this, i), t.performVisualTasks(i), hs(this, this._model,
			...
			this._model.setOption(t, ew), n ? (this[Y_] = {
				silent: i
			}, this[X_] = !1) : (Qa(this), $_.update.call(this), this._zr.flush(), this[Y_] = !1, this[X_] = !1, ns.call(this,
				i), is.call(this, i))
			...
			if (Kp.canvasSupported) return (t = t || {}).pixelRatio = t.pixelRatio || 1, t.backgroundColor = t.backgroundColor ||
		...
		}, q_.convertToPixel = v(Ka, "convertToPixel"), q_.convertFromPixel = v(Ka, "convertFromPixel"), q_.containPixel =
		function(t, e) {
			var n;
	...
	var $_ = {
		...
		update: function(t) {
			var e = this._model,
				...
				o = this._scheduler;
			if (e) {
				o.restoreData(e, t), o.performSeriesTasks(e), r.create(e, n), o.performDataProcessorTasks(e, t), ts(this, e), r.update(
					e, n), as(e), o.performVisualTasks(e, t), ss(this, e, n, t);
				var a = e.get("backgroundColor") || "transparent";
				if (Kp.canvasSupported) i.setBackgroundColor(a);
				else {
					var s = Nt(a);
	...
	q_.resize = function(t) {
		...
		F_(e) || (e = {
			silent: !!e
		}), Q_[t.type] && this._model && (this[X_] ? this._pendingActions.push(t) : (es.call(this, t, e.silent), e.flush ?
			this._zr.flush(!0) : !1 !== e.flush && Kp.browser.weChat && this._throttledZrFlush(), ns.call(this, e.silent),
			is.call(this, e.silent)))
	...
	var K_ = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout",
		"contextmenu"
	];
	q_._initEvents = function() {
		...
		filter: function(t, e, n) {
			...
			var h = e.cptQuery,
				u = e.dataQuery;
			return i(h, s, "mainType") && i(h, s, "subType") && i(h, s, "index", "componentIndex") && i(h, s, "name") && i(h,
				s, "id") && i(u, a, "name") && i(u, a, "dataIndex") && i(u, a, "dataType") && (!l.filterForExposedEvent || l.filterForExposedEvent(
				t, e.otherQuery, o, a))
		},
	...
	Ls.prototype = {
		...
		execute: function() {
			var t = this._old,
				...
				i = [],
				r = [];
			for (Os(t, {}, i, "_oldKeyGetter", this), Os(e, n, r, "_newKeyGetter", this), o = 0; o < t.length; o++) null != (
				s = n[a = i[o]]) ? ((h = s.length) ? (1 === h && (n[a] = null), s = s.unshift()) : n[a] = null, this._update &&
	...
	var fw = N(["tooltip", "label", "itemName", "itemId", "seriesName"]),
		...
		ww = ["hasItemOption", "_nameList", "_idList", "_invertedIndicesMap", "_rawData", "_chunkSize", "_chunkCount",
		...
		Sw = function(t, e) {
			...
			this.dimensions = i, this._dimensionInfos = n, this.hostModel = e, this.dataType, this._indices = null, this._count =
				...
				this._dimensionsSummary = zs(this), this._invertedIndicesMap = r, this._calculationInfo = {}
		},
		Mw = Sw.prototype;
	Mw.type = "list", Mw.hasItemOption = !0, Mw.getDimension = function(t) {
		...
		(so.isInstance(t) || c(t)) && (t = new jo(t, this.dimensions.length)), this._rawData = t, this._storage = {}, this._indices =
			null, this._nameList = e || [], this._idList = [], this._nameRepeatCount = {}, n || (this.hasItemOption = !1),
			this.defaultDimValueGetter = jx[this._rawData.getSource().sourceFormat], this._dimValueGetter = n = n || this.defaultDimValueGetter,
			this._dimValueGetterArrayRows = jx.arrayRows, this._rawExtent = {}, this._initDataFromProvider(0, t.count()), t.pure &&
		...
		for (var n = this._chunkSize, i = this._storage, r = this.dimensions, o = r.length, a = this._rawExtent, s = this.count(),
				l = s + Math.max(t.length, e ? e.length : 0), h = this._chunkCount, u = 0; u < o; u++) a[v = r[u]] || (a[v] = [1 /
			0, -1 / 0
		]), i[v] || (i[v] = []), Vs(i, this._dimensionInfos[v], n, h, l), this._chunkCount = i[v].length;
		...
		if (!(t >= e)) {
			for (var n, i = this._chunkSize, r = this._rawData, o = this._storage, a = this.dimensions, s = a.length, l = this
				...
				c[w = a[p]] || (c[w] = [1 / 0, -1 / 0]);
				var g = l[w];
				0 === g.otherDims.itemName && (n = this._nameDimIdx = p), 0 === g.otherDims.itemId && (this._idDimIdx = p), o[w] ||
					(o[w] = []), Vs(o, g, i, f, e), this._chunkCount = o[w].length
			}
			for (var m = new Array(s), v = t; v < e; v++) {
				...
				if (!r.pure) {
					...
					null == D && null != I && (d[I] = d[I] || 0, D = I, d[I] > 0 && (D += "__ec__" + d[I]), d[I]++), null != D && (u[
						v] = D)
				}
		...
		if (t) {
			...
			for (var i = new(e = Rs(this))(this.count()), r = 0; r < i.length; r++) i[r] = r;
		return i
	}, Mw.get = function(t, e) {
		...
		if (this._count) {
			...
			return l < r && (this._indices = o), this._count = l, this._extent = {}, this.getRawIndex = this._indices ? Zs :
				Gs, this
		}
		...
		if (this._count) {
			...
			if (i) {
				...
				return a < r && (this._indices = o), this._count = a, this._extent = {}, this.getRawIndex = this._indices ? Zs :
					Gs, this
			}
		}
		...
		for (var o = r._storage, a = [], s = this._chunkSize, l = t.length, h = this.count(), u = [], c = r._rawExtent, d =
				0; d < h; d++) {
		...
		for (var r = Ys(this, [t]), o = r._storage, a = [], s = Math.floor(1 / e), l = o[t], h = this.count(), u = this._chunkSize,
				c = r._rawExtent[t], d = new(Rs(this))(h), f = 0, p = 0; p < h; p += s) {
	...
	}, Mw.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"], Mw.CHANGABLE_METHODS = ["filterSelf",
		"selectRange"
	];
	var Tw = function(t, e) {
		...
		Ew = {
			...
			reset: function(t) {
				if (_l(t) && wl(t)) {
					...
					return h > .5 || (h = .5), {
						progress: function(t, e) {
							for (var i, u = new zw(2 * t.count), c = [], d = [], f = 0; null != (i = t.next());) d[l] = e.get(o, i), d[1 -
								l] = e.get(a, i), c = n.dataToPoint(d, null, c), u[f++] = c[0], u[f++] = c[1];
							e.setLayout({
								largePoints: u,
								barWidth: h,
		...
		tb = Bi({
			...
			buildPath: function(t, e) {
				var n = e.x,
					...
					f = .6 * a,
					p = .7 * a;
				t.moveTo(n - u, l + s), t.arc(n, l, a, Math.PI - h, 2 * Math.PI + h), t.bezierCurveTo(n + u - c * f, l + s + d *
					f, n, i - p, n, i), t.bezierCurveTo(n, i - p, n - u + c * f, l + s + d * f, n - u, l + s), t.closePath()
			}
		}),
		eb = Bi({
			type: "arrow",
	...
	var rb = Bi({
			...
			buildPath: function(t, e, n) {
				var i = e.symbolType,
					r = ib[i];
				"none" !== e.symbolType && (r || (r = ib[i = "rect"]), nb[i](e.x, e.y, e.width, e.height, r.shape), r.buildPath(
					t, r.shape, n))
			}
		}),
		ob = {
	...
	gb._createSymbol = function(t, e, n, i, r) {
		...
		} else(l = this.childAt(0)).silent = !1, vr(l, {
			scale: ah(o)
		}, r, e);
	...
	gb._updateCommon = function(t, e, n, i) {
		...
		if (!i || t.hasItemOption) {
			...
			l = m.getModel(vb).getItemStyle(["color"]), h = m.getModel(yb).getItemStyle(), u = m.getShallow("symbolRotate"), c =
				m.getShallow("symbolOffset"), d = m.getModel(xb), f = m.getModel(_b), p = m.getShallow("hoverAnimation"), g = m.getShallow(
					"cursor")
		} else h = o({}, h);
		var v = r.style;
		r.attr("rotation", (u || 0) * Math.PI / 180 || 0), c && r.attr("position", [Pr(c[0], n[0]), Pr(c[1], n[1])]), g &&
		...
		sr(v, h, d, f, {
				...
				isRectText: !0,
				autoColor: s
			}), r.off("mouseover").off("mouseout").off("emphasis").off("normal"), r.hoverStyle = h, or(r), r.__symbolOriginalScale =
			ah(n), p && a.isAnimationEnabled() && r.on("mouseover", lh).on("mouseout", hh).on("emphasis", uh).on("normal", ch)
	...
	var bb = function(t, e, n, i, r, o, a, s) {
			for (var l = xh(t, e), h = [], u = [], c = [], d = [], f = [], p = [], g = [], m = mh(r, e, a), v = mh(o, t, s), y =
					0; y < l.length; y++) {
				var x = l[y],
					_ = !0;
				switch (x.cmd) {
					case "=":
						...
						(isNaN(w[0]) || isNaN(w[1])) && (w = b.slice()), h.push(w), u.push(b), c.push(n[x.idx]), d.push(i[x.idx1]), g.push(
							e.getRawIndex(x.idx1));
						break;
					case "+":
						S = x.idx;
						h.push(r.dataToPoint([e.get(m.dataDimsForPoint[0], S), e.get(m.dataDimsForPoint[1], S)])), u.push(e.getItemLayout(
							S).slice()), c.push(yh(m, r, e, S)), d.push(i[S]), g.push(e.getRawIndex(S));
						break;
					case "-":
						var S = x.idx,
							M = t.getRawIndex(S);
						M !== S ? (h.push(t.getItemLayout(S)), u.push(o.dataToPoint([t.get(v.dataDimsForPoint[0], S), t.get(v.dataDimsForPoint[
							1], S)])), c.push(n[S]), d.push(yh(v, o, t, S)), g.push(M)) : _ = !1
				}
	...
	ga.extend({
		...
		render: function(t, e, n) {
			...
			var S = !u && t.get("step");
			f && c.type === i.type && S === this._step ? (v && !p ? p = this._newPolygon(h, x, i, m) : p && !v && (g.remove(
				p), p = this._polygon = null), g.setClipPath(Ph(i, !1, !1, t)), _ && d.updateData(o, {
				isIgnore: w,
				clipShape: Ph(i, !1, !0, t)
			}), o.eachItemGraphicEl(function(t) {
				t.stopAnimation(!0)
			}), Ih(this._stackedOnPoints, x) && Ih(this._points, h) || (m ? this._updateAnimation(o, x, i, n, S, y) : (S &&
				(h = Lh(h, i, S), x = Lh(x, i, S)), f.setShape({
					points: h
				}), p && p.setShape({
					points: h,
					stackedOnPoints: x
				...
				isIgnore: w,
				clipShape: Ph(i, !1, !0, t)
			}), S && (h = Lh(h, i, S), x = Lh(x, i, S)), f = this._newPolyline(h, i, m), v && (p = this._newPolygon(h, x,
				i, m)), g.setClipPath(Ph(i, !0, !1, t)));
			...
			this._data = o, this._coordSys = i, this._stackedOnPoints = x, this._points = h, this._step = S, this._valueOrigin =
				y
		},
		dispose: function() {},
		highlight: function(t, e, n, i) {
			...
			if (!(o instanceof Array) && null != o && o >= 0) {
				...
				if (!a) {
					...
					if (!s) return;
					(a = new oh(r, o)).position = s, a.setZ(t.get("zlevel"), t.get("z")), a.ignore = isNaN(s[0]) || isNaN(s[1]), a
		...
		_updateAnimation: function(t, e, n, i, r, o) {
			var a = this._polyline,
				...
				d = h.next,
				f = h.stackedOnNext;
			r && (u = Lh(h.current, n, r), c = Lh(h.stackedOnCurrent, n, r), d = Lh(h.next, n, r), f = Lh(h.stackedOnNext, n,
				r)), a.shape.__points = h.current, a.shape.points = u, vr(a, {
				shape: {
					points: d
				}
			}, l), s && (s.setShape({
						...
						return {
							dataEach: o.hasItemOption || h ? function(e, n) {
								...
								if (e.hasItemOption) {
									...
									null != a && e.setItemVisual(n, "symbol", a), null != l && e.setItemVisual(n, "symbolSize", l), null != h &&
	...
	Zb.type = "grid", Zb.axisPointerEnabled = !0, Zb.getRect = function() {
		...
		var n, i, r = e.seriesModel,
			...
			s = e.gridModel,
			h = this._coordsList;
		return r ? l(h, n = r.coordinateSystem) < 0 && (n = null) : o && a ? n = this.getCartesian(o.componentIndex, a.componentIndex) :
			...
			return function(i, s) {
				if (Fh(i, t, e)) {
					...
					h.onBand = u && i.get("boundaryGap"), h.inverse = i.get("inverse"), i.axis = h, h.model = i, h.grid = this, h.index =
						s, this._axesList.push(h), o[n][s] = h, a[n]++
				}
			}
		}
		var r = {
	...
	var jb = {
			...
			axisName: function() {
				...
				if (n) {
					var i, r = e.get("nameLocation"),
						...
						u = h[0] > h[1] ? -1 : 1,
						c = ["start" === r ? h[0] - u * l : "end" === r ? h[1] + u * l : (h[0] + h[1]) / 2, Qh(r) ? t.labelOffset + a *
							l : 0
						],
						d = e.get("nameRotate");
					null != d && (d = d * Xb / 180);
					var f;
					Qh(r) ? i = qb(t.rotation, null != d ? d : t.rotation, a) : (i = Yh(t, r, d || 0, h), null != (f = t.axisNameAvailableWidth) &&
					...
					lr(b.style, s, {
						...
						}), e.get("triggerEvent") && (b.eventData = Xh(e), b.eventData.targetType = "axisName", b.eventData.name = n),
		...
		qb = Yb.innerTextLayout = function(t, e, n) {
			var i, r, o = Br(e - t);
			return Fr(o) ? (r = n > 0 ? "top" : "bottom", i = "center") : Fr(o - Xb) ? (r = n > 0 ? "bottom" : "top", i =
				"center") : (r = "middle", i = o > 0 && o < Xb ? n > 0 ? "right" : "left" : n > 0 ? "left" : "right"), {
				rotation: o,
				textAlign: i,
				textVerticalAlign: r
			}
		...
		return {
			...
			reset: function(t, e, n) {
				...
				if ("cartesian2d" === o.type && r) {
					...
					if (u > 1) {
						var c;
						"string" == typeof r ? c = zb[r] : "function" == typeof r && (c = r), c && t.setData(i.downSample(i.mapDimension(
							s.dim), 1 / u, c, Eb))
					}
				}
			}
		...
		_renderNormal: function(t, e, n) {
			...
			o.diff(a).add(function(e) {
				...
				if (o.hasValue(e)) {
					...
					l ? vr(l, {
						shape: c
					}, h, e) : l = aS[s.type](o, e, u, c, i, h, !0), o.setItemGraphicEl(e, l), r.add(l), xu(l, o, e, u, c, t, i,
						"polar" === s.type)
				} else r.remove(l)
			}).remove(function(t) {
	...
	Ss(v(function(t, e) {
		...
		d(n, function(t) {
			...
			for (var d = e.mapDimension(u.dim), f = e.mapDimension(o.dim), p = tl(e, d), g = u.isHorizontal(), m = bl(0, u),
					v = 0, y = e.count(); v < y; v++) {
				var x = e.get(d, v),
					_ = e.get(f, v);
				if (!isNaN(x)) {
					...
					var S, M, I, T;
					if (g) S = b, M = (A = n.dataToPoint([x, _]))[1] + l, I = A[0] - m, T = h, Math.abs(I) < c && (I = (I < 0 ?
						-1 : 1) * c), p && (r[a][_][w] += I);
					else {
						var A = n.dataToPoint([_, x]);
						S = A[0] + l, M = b, I = h, T = A[1] - m, Math.abs(T) < c && (T = (T <= 0 ? -1 : 1) * c), p && (r[a][_][w] +=
							T)
					}
					e.setItemLayout(v, {
						x: S,
	...
	dS.updateData = function(t, e, n) {
		...
		f && s.attr("cursor", f), Mu(this, t.getItemLayout(e), l.isSelected(null, e), l.get("selectedOffset"), l.get(
				"animation")), s.off("mouseover").off("mouseout").off("emphasis").off("normal"), h.get("hoverAnimation") && l.isAnimationEnabled() &&
			s.on("mouseover", i).on("mouseout", r).on("emphasis", i).on("normal", r), this._updateLabel(t, e), or(this)
	...
	vS.isPersistent = function() {
		...
		t.setShape("size", r instanceof Array ? r : [r, r]), t.symbolProxy = Nl(e.getVisual("symbol"), 0, 0, 0, 0), t.setColor =
		...
		_updateSymbolDraw: function(t, e) {
			...
			return n && i === this._isLargeDraw || (n && n.remove(), n = this._symbolDraw = i ? new Du : new dh, this._isLargeDraw =
			...
			if (e) {
				...
				d(e, function(e) {
					var r = e.$action,
						...
						l = null != s ? n.get(s) : i,
						h = e.style;
					"text" === e.type && h && (e.hv && e.hv[1] && (h.textVerticalAlign = h.textBaseline = null), !h.hasOwnProperty(
						"textFill") && h.fill && (h.textFill = h.fill), !h.hasOwnProperty("textStroke") && h.stroke && (h.textStroke =
						h.stroke));
					var u = Lu(e);
					r && "merge" !== r ? "replace" === r ? (Pu(a, n), ku(o, l, u, n)) : "remove" === r && Pu(a, n) : a ? a.attr(
						u) : ku(o, l, u, n);
					var c = n.get(o);
	...
	(ec.prototype = {
		...
		render: function(t, e, n, i) {
			...
			if (this._axisModel = t, this._axisPointerModel = e, this._api = n, i || this._lastValue !== r || this._lastStatus !==
				...
				} else a = this._group = new am, this.createPointerEl(a, l, t, e), this.createLabelEl(a, l, t, e), n.getZr().add(
					a);
		...
		_renderHandle: function(t) {
			if (!this._dragging && this.updateHandleTransform) {
				...
				var l = r.get("size");
				y(l) || (l = [l, l]), i.attr("scale", [l[0] / 2, l[1] / 2]), wa(this, "_doDispatchAxisPointer", r.get("throttle") ||
					0, "fixRate"), this._moveHandleToValue(t, a)
			}
		},
		_moveHandleToValue: function(t, e) {
			nc(this._axisPointerModel, !e && this._moveAnimation, this._handle, oc(this.getHandleTransform(t, this._axisModel,
	...
	_c.prototype = {
		...
		show: function(t) {
			...
			var e = this.el;
			e.style.cssText = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;" + xc(t) +
	...
	Cs({
		...
		manuallyHideTip: function(t, e, n, i) {
			...
			!this._alwaysShowContent && this._tooltipModel && r.hideLater(this._tooltipModel.get("hideDelay")), this._lastX =
				this._lastY = null, i.from !== this.uid && this._hide(Sc(i, n))
		},
		_manuallyAxisShowTip: function(t, e, n, i) {
			...
			if (null != r && null != o && null != a) {
				...
				if (s && "axis" === (t = bc([s.getData().getItemModel(o), s, (s.coordinateSystem || {}).model, t])).get(
					...
					if (e && null != r) {
						...
						d(t.seriesDataIndices, function(a) {
							...
							if (f.axisDim = t.axisDim, f.axisIndex = t.axisIndex, f.axisType = t.axisType, f.axisId = t.axisId, f.axisValue =
								kl(e.axis, r), f.axisValueLabel = l, f) {
								s.push(f);
		...
		_showTooltipContent: function(t, e, n, i, r, o, a, s, l) {
			if (this._ticket = "", t.get("showContent") && t.get("show")) {
				...
				a = a || t.get("position");
				var c = e;
				if (u && "string" == typeof u) c = Yr(u, n, !0);
		...
		_updatePosition: function(t, e, n, i, r, o, a) {
			...
			} else "string" == typeof e && a ? (n = (p = Tc(e, d, h))[0], i = p[1]) : (n = (p = Mc(n, i, r, s, l, u ? null :
				20, c ? null : 20))[0], i = p[1]);
			if (u && (n -= Ac(u) ? h[0] / 2 : "right" === u ? h[0] : 0), c && (i -= Ac(c) ? h[1] / 2 : "bottom" === c ? h[1] :
					0), t.get("confine")) {
				var p = Ic(n, i, r, s, l);
				n = p[0], i = p[1]
			}
	...
	bs("legendToggleSelect", "legendselectchanged", v(Cc, "toggleSelected")), bs("legendSelect", "legendselected", v(Cc,
		"select")), bs("legendUnSelect", "legendunselected", v(Cc, "unSelect"));
	var FS = v,
		VS = d,
		HS = am,
		WS = Cs({
			...
			render: function(t, e, n) {
				...
				if (this._isFirstRender = !1, this.resetInner(), t.get("show", !0)) {
					var r = t.get("align");
					r && "auto" !== r || (r = "right" === t.get("left") && "vertical" === t.get("orient") ? "right" : "left"), this
						.renderInner(r, t, e, n);
					...
					if (this.newlineDisabled || "" !== u && "\n" !== u) {
						...
						if (!o.get(u))
							if (c) {
								...
								this._createItem(u, h, l, e, p, g, t, f, a).on("click", FS(Pc, u, i)).on("mouseover", FS(Lc, c.name, null,
									i, s)).on("mouseout", FS(Oc, c.name, null, i, s)), o.set(u, !0)
								...
								if (!o.get(u) && n.legendDataProvider) {
									...
									this._createItem(u, h, l, e, "roundRect", null, t, d, a).on("click", FS(Pc, u, i)).on("mouseover", FS(
										Lc, null, u, i, s)).on("mouseout", FS(Oc, null, u, i, s)), o.set(u, !0)
								}
							}, this)
					} else r.add(new HS({
						newline: !0
	...
	var GS = BS.extend({
		...
		YS = WS.extend({
			...
			newlineDisabled: !0,
			init: function() {
				YS.superCall(this, "init"), this._currentIndex = 0, this.group.add(this._containerGroup = new ZS), this._containerGroup
					.add(this.getContentGroup()), this.group.add(this._controllerGroup = new ZS), this._showController
			},
			resetInner: function() {
				YS.superCall(this, "resetInner"), this._controllerGroup.removeAll(), this._containerGroup.removeClipPath(), this
			...
			layoutInner: function(t, e, n, i) {
				var r = this.getContentGroup(),
					...
					h = US[1 - s],
					u = XS[1 - s];
				ux(t.get("orient"), r, t.get("itemGap"), s ? n.width : null, s ? null : n.height), ux("horizontal", a, t.get(
					"pageButtonItemGap", !0));
				...
				f && ("end" === t.get("pageButtonPosition", !0) ? m[s] += n[l] - d[l] : g[s] += d[l] + v), m[1 - s] += c[h] / 2 -
					d[h] / 2, r.attr("position", p), o.attr("position", g), a.attr("position", m);
				var y = this.group.getBoundingRect();
				if ((y = {
						x: 0,
						y: 0
					})[l] = f ? n[l] : c[l], y[h] = Math.max(c[h], d[h]), y[u] = Math.min(0, d[u] + m[1 - s]), o.__rectSize = n[l],
					f) {
					var x = {
						x: 0,
						y: 0
			...
			_getPageInfo: function(t) {
				...
				for (var m = h + 1, v = g, y = g, x = null; m <= d; ++m)(!(x = e(u[m])) && y.e > v.s + o || x && !n(x, v.s)) &&
					(v = y.i > v.i ? y : x) && (null == p.pageNextDataIndex && (p.pageNextDataIndex = v.i), ++p.pageCount), y = x;
				for (var m = h - 1, v = g, y = g, x = null; m >= -1; --m)(x = e(u[m])) && n(y, x.s) || !(v.i < y.i) || (y = v,
					null == p.pagePrevDataIndex && (p.pagePrevDataIndex = v.i), ++p.pageCount, ++p.pageIndex), v = x;
				return p
			},
		...
		$S = As({
			...
			formatTooltip: function(t) {
				var e = this.getData(),
					...
					r = e.getName(t),
					o = qS(this.name);
				return (null != n || r) && (o += "<br />"), r && (o += qS(r), null != n && (o += " : ")), null != n && (o += qS(
					i)), o
			},
			getData: function() {
				return this._data
	...
	oM.beforeUpdate = function() {
		...
		if (e || n || !i.ignore) {
			...
			if (this.__dirty || a.__dirty) {
				var s = a.shape.percent,
					...
					h = a.pointAt(s),
					u = G([], h, l);
				if (Y(u, u), e && (e.attr("position", l), c = a.tangentAt(0), e.attr("rotation", Math.PI / 2 - Math.atan2(c[1], c[
				...
				if (!i.ignore) {
					i.attr("position", h);
					var d, f, p, g = 5 * r;
					if ("end" === i.__position) d = [u[0] * g + h[0], u[1] * g + h[1]], f = u[0] > .8 ? "left" : u[0] < -.8 ?
						"right" : "center", p = u[1] > .8 ? "top" : u[1] < -.8 ? "bottom" : "middle";
		...
		if (!n || t.hasItemOption) {
			...
			o = u.getModel("lineStyle").getLineStyle(), s = u.getModel("emphasis.lineStyle").getLineStyle(), l = u.getModel(
	...
	pM.prototype = {
		...
		calculateDataWindow: function(t) {
			...
			return dM(["startValue", "endValue"], function(e) {
				...
				var s = a[t],
					l = o[t];
				"percent" === i[t] ? (null == l && (l = r[t]), s = n.parse(kr(l, r, e, !0))) : l = kr(s, e, r, !0), a[t] = s,
					o[t] = l
			}), {
				valueWindow: fM(a),
				percentWindow: fM(o)
	...
	var gM = d,
		...
		vM = As({
			...
			doInit: function(t) {
				var e = this.option;
				Kp.canvasSupported || (e.realtime = !1), this._setDefaultThrottle(t), bd(this, t), gM([
					["start", "startValue"],
					["end", "endValue"]
				], function(t, n) {
		...
		xM = (vM.extend({
			...
			var a = n[1] - n[0];
			null != r && (r = Md(r, [0, a])), null != o && (o = Math.max(o, null != r ? r : 0)), "all" === i && (r = o = Math.abs(
				e[1] - e[0]), i = 0);
			var s = Sd(e, i);
			e[i] += t;
			var l = r || 0,
		...
		CM = yM.extend({
			...
			render: function(t, e, n, i) {
				CM.superApply(this, "render", arguments), wa(this, "_dispatchZoomAction", this.dataZoomModel.get("throttle"),
			...
			_renderHandle: function() {
				...
				i.add(t.filler = new _M({
					...
					var r = Mr(o.get("handleIcon"), {
						...
						a = r.getBoundingRect();
					this._handleHeight = Pr(o.get("handleSize"), this._size[1]), this._handleWidth = a.width / a.height * this._handleHeight,
			...
			_updateInterval: function(t, e) {
				var n = this.dataZoomModel,
					...
					a = [0, 100];
				xM(e, i, r, n.get("zoomLock") ? "all" : t, null != o.minSpan ? wM(o.minSpan, a, r, !0) : null, null != o.maxSpan ?
					wM(o.maxSpan, a, r, !0) : null);
				var s = this._range,
	...
	var kM = "\0_ec_dataZoom_roams",
		...
		LM = yM.extend({
			...
			render: function(t, e, n, i) {
				LM.superApply(this, "render", arguments), this._range = t.getPercentRange(), d(this.getTargetCoordInfo(),
					function(e, i) {
		...
		zM = {
			...
			polar: function(t, e, n, i, r) {
				...
				return t = t ? s.pointToCoord(t) : [0, 0], e = s.pointToCoord(e), "radiusAxis" === n.mainType ? (a.pixel = e[0] -
					...
					a.pixelLength = h[1] - h[0], a.pixelStart = h[0], a.signal = o.inverse ? -1 : 1), a
			},
		...
		render: function(t, e, n, i) {
			...
			function o(i, r, o) {
				...
				d(u, function(o, u) {
					...
					d.setStyle(l.getItemStyle()), d.hoverStyle = h.getItemStyle(), or(d), t.get("showTitle") && (d.__title = c[u],
						...
						})), d.trigger(i.get("iconStatus." + u) || "normal"), a.add(d), d.on("click", m(r.onclick, r, e, n, u)), g[
						u] = d
				})
			}
			var a = this.group;
			if (a.removeAll(), t.get("show")) {
				...
				d(l, function(t, e) {
						u.push(e)
					}), new Ls(this._featureNames || [], u).add(r).update(r).remove(v(r, null)).execute(), this._featureNames = u,
					Dc(a, t, n), a.add(kc(a.getBoundingRect(), t)), a.eachChild(function(t) {
						var e = t.__title,
							i = t.hoverStyle;
						if (i && e) {
							var r = Te(e, He(i)),
							...
							o + r.width / 2 > n.getWidth() ? (i.textPosition = ["100%", h], i.textAlign = "right") : o - r.width / 2 <
								0 && (i.textPosition = [0, h], i.textAlign = "left")
						}
					})
			}
		},
	...
	uf.defaultOption = {
		...
		} else l.appendChild(h), h.readOnly = r.get("readOnly"), h.style.cssText =
			"width:100%;height:100%;font-family:monospace;font-size:14px;line-height:1.6rem;", h.style.color = r.get(
				"textColor"), h.style.borderColor = r.get("textareaBorderColor"), h.style.backgroundColor = r.get("textareaColor"),
			h.value = d.value;
		var p = d.meta,
		...
		st(v, "click", n), st(y, "click", function() {
			...
			y), g.appendChild(v), st(h, "keydown", function(t) {
	...
	var aI = {
			mousedown: function(t) {
				if (this._dragging) Uf.call(this, t);
	...
	II._onBrush = function(t, e) {
		function n(t, e, n) {
			...
			null == h.minValueSpan && null == h.maxValueSpan || (n = xM(0, n.slice(), a.scale.getExtent(), 0, h.minValueSpan,
				h.maxValueSpan)), l && (r[l.id] = {
				dataZoomId: l.id,
				startValue: n[0],
				endValue: n[1]
			})
	...
	var CI, DI = "urn:schemas-microsoft-com:vml",
	...
	if (!Kp.canvasSupported) {
		var VI = 21600,
			HI = VI / 2,
			WI = function(t) {
				t.style.cssText = "position:absolute;left:0;top:0;width:1px;height:1px;", t.coordsize = VI + "," + VI, t.coordorigin =
					"0,0"
			},
			GI = function(t) {
					...
					if (i instanceof Py) {
						...
						if (b >= 2) {
							var C = S[0][0],
								...
								k = S[0][1] * e.opacity,
								P = S[1][1] * e.opacity;
							t.type = r, t.method = "none", t.focus = "100%", t.angle = o, t.color = C, t.color2 = D, t.colors = M.join(","),
			...
			QI = function(t, e) {
				null != e.lineDash && (t.dashstyle = e.lineDash.join(" ")), null == e.stroke || e.stroke instanceof Py || qI(t, e.stroke,
					e.opacity)
			},
			JI = function(t, e, n, i) {
				var r = "fill" === e,
					o = t.getElementsByTagName(e)[0];
				null != n[e] && "none" !== n[e] && (r || !r && n.lineWidth) ? (t[r ? "filled" : "stroked"] = "true", n[e] instanceof Py &&
					XI(t, o), o || (o = gp(e)), r ? KI(o, n, i) : QI(o, n), UI(t, o)) : (t[r ? "filled" : "stroked"] = "false", XI(t,
					o))
			},
			tT = [
				[],
					...
					switch (r = p[o++], i = "", n = 0, r) {
						...
						case h:
							...
							r === d ? (m = _, v = w, _ = (_ + 2 * y) / 3, w = (w + 2 * x) / 3, y = (a + 2 * y) / 3, x = (s + 2 * x) / 3) :
								(m = p[o++], v = p[o++]), tT[0][0] = y, tT[0][1] = x, tT[1][0] = _, tT[1][1] = w, tT[2][0] = m, tT[2][1] = v,
								a = m, s = v;
							break;
						case c:
							var b = 0,
								...
								I = 1,
								T = 0;
							e && (b = e[4], S = e[5], M = EI(e[0] * e[0] + e[1] * e[1]), I = EI(e[2] * e[2] + e[3] * e[3]), T = Math.atan2(
								-e[1] / I, e[0] / M));
							var A = p[o++],
								C = p[o++],
								D = p[o++],
							...
							var O = p[o++],
								...
								x = C + BI(L) * k,
								N = O ? " wa " : " at ";
							Math.abs(z - y) < 1e-4 && (Math.abs(L - P) > .01 ? O && (z += .0125) : Math.abs(E - C) < 1e-4 ? O && z < A || !
								O && z > A ? x -= .0125 : x += .0125 : O && E < C || !O && E > C ? y += .0125 : y -= .0125), f.push(N, zI(((A -
								D) * M + b) * VI - HI), ",", zI(((C - k) * I + S) * VI - HI), ",", zI(((A + D) * M + b) * VI - HI), ",", zI(
								((C + k) * I + S) * VI - HI), ",", zI((z * M + b) * VI - HI), ",", zI((E * I + S) * VI - HI), ",", zI((y * M +
								b) * VI - HI), ",", zI((x * I + S) * VI - HI)), a = y, s = x;
							break;
						case OI.R:
							var R = tT[0],
								B = tT[1];
							R[0] = p[o++], R[1] = p[o++], B[0] = R[0] + p[o++], B[1] = R[1] + p[o++], e && ($(R, R, e), $(B, B, e)), R[0] =
								zI(R[0] * VI - HI), B[0] = zI(B[0] * VI - HI), R[1] = zI(R[1] * VI - HI), B[1] = zI(B[1] * VI - HI), f.push(
		...
		Ii.prototype.brushVML = function(t) {
			...
			this.__dirtyPath && (l.beginPath(), l.subPixelOptimize = !1, this.buildPath(l, this.shape), l.toStatic(), this.__dirtyPath = !
					1), n.path = eT(l, this.transform), n.style.zIndex = YI(this.zlevel, this.z, this.z2), UI(t, n), null != e.text ?
		...
		hn.prototype.brushVML = function(t) {
			...
			if (r) {
				...
				var x, _ = y.style,
					...
					b = 1,
					S = 1;
				if (this.transform && (x = this.transform, b = EI(x[0] * x[0] + x[1] * x[1]), S = EI(x[2] * x[2] + x[3] * x[3]),
						w = x[1] || x[2]), w) {
					var M = [h, u],
						I = [h + c, u],
						T = [h, u + d],
					...
					var C = FI(M[0], I[0], T[0], A[0]),
						...
						k = [];
					k.push("M11=", x[0] / b, ",", "M12=", x[2] / S, ",", "M21=", x[1] / b, ",", "M22=", x[3] / S, ",", "Dx=", zI(h *
							b + x[4]), ",", "Dy=", zI(u * S + x[5])), _.padding = "0 " + zI(C) + "px " + zI(D) + "px 0", _.filter =
				...
				var O = P.style;
				if (v) {
					if (e && n) O.width = zI(b * e * c / f) + "px", O.height = zI(S * n * d / p) + "px";
					else {
						var z = new Image,
							E = this;
						z.onload = function() {
							z.onload = null, e = z.width, n = z.height, O.width = zI(b * e * c / f) + "px", O.height = zI(S * n * d / p) +
								"px", E._imageWidth = e, E._imageHeight = n, E._imageSrc = r
						}, z.src = r
					}
					L || ((L = LI.createElement("div")).style.overflow = "hidden", this._cropEl = L);
					var N = L.style;
					N.width = zI((c + g * c / f) * b), N.height = zI((d + m * d / p) * S), N.filter =
				...
				} else O.width = zI(b * c) + "px", O.height = zI(S * d) + "px", y.appendChild(P), L && L.parentNode && (y.removeChild(
					L), this._cropEl = null);
				var R = "",
					B = i.opacity;
				B < 1 && (R += ".Alpha(opacity=" + zI(100 * B) + ") "), R +=
					"progid:DXImageTransform.Microsoft.AlphaImageLoader(src=" + r + ", SizingMethod=scale)", O.filter = R, y.style.zIndex =
					YI(this.zlevel, this.z, this.z2), UI(t, y), null != i.text && this.drawRectText(t, this.getBoundingRect())
			}
		...
		! function(t, e) {
			...
			var n = LI;
			iT || ((iT = n.createElement("div")).style.cssText =
				"position:absolute;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;", LI.body.appendChild(iT)
			);
			try {
				iT.style.font = e
			} catch (t) {}
		...
		for (var lT = new se, hT = [zm, ln, hn, Ii, dy], uT = 0; uT < hT.length; uT++) {
			...
			cT.drawRectText = function(t, e, n, i) {
				...
				if (null != o && (o += ""), o) {
					...
					if (v && !i && (lT.copy(e), lT.applyTransform(v), e = lT), i) c = e.x, d = e.y;
					else {
						var y = r.textPosition,
							x = r.textDistance;
						if (y instanceof Array) c = e.x + jI(y[0], e.width), d = e.y + jI(y[1], e.height), f = f || "left";
						else {
							var _ = Pe(y, e, x);
					...
					I ? b = (w = (S = I.firstChild).nextSibling).nextSibling : (I = M("line"), w = M("path"), b = M("textpath"), S =
						M("skew"), b.style["v-text-align"] = "left", WI(I), w.textpathok = !0, b.on = !0, I.from = "0 0", I.to =
						"1000 0.05", UI(I, S), UI(I, w), UI(I, b), this._textVmlEl = I);
					var T = [c, d],
						A = I.style;
					v && i ? ($(T, T, v), S.on = !0, S.matrix = v[0].toFixed(3) + "," + v[2].toFixed(3) + "," + v[1].toFixed(3) +
						"," + v[3].toFixed(3) + ",0,0", S.offset = (zI(T[0]) || 0) + "," + (zI(T[1]) || 0), S.origin = "0 0", A.left =
						"0px", A.top = "0px") : (S.on = !1, A.left = zI(c) + "px", A.top = zI(d) + "px"), b.string = GI(o);
					try {
						b.style.font = m
					} catch (t) {}
					JI(I, "fill", {
	...
	MT.brush = function(t) {
		...
		if (n instanceof HTMLImageElement && (n = n.src), n) {
			var i = e.x || 0,
				...
				a = e.height,
				s = t.__svgEl;
			s || (s = _p("image"), t.__svgEl = s), n !== t.__imageSrc && (Ap(s, "href", n), t.__imageSrc = n), Tp(s, "width",
				o), Tp(s, "height", a), Tp(s, "x", i), Tp(s, "y", r), Ip(s, t.transform), null != e.text && AT(t, t.getBoundingRect())
		}
	};
	var IT = {},
		TT = new se,
		AT = function(t, e, n) {
			...
			if (null != r) {
				...
				var g = i.textPadding;
				if (Tp(o, "x", a), Tp(o, "y", s), Cp(o, i, !0, t), t instanceof dy || t.style.transformText) Ip(o, t.transform);
				else {
					if (t.transform) TT.copy(e), TT.applyTransform(t.transform), e = TT;
					else {
				...
				if ("after-edge" === d ? (S = -n.height + f, g && (S -= g[2])) : "middle" === d ? (S = (-n.height + f) / 2, g && (
					...
					var M = t.__tspanList || [];
					t.__tspanList = M;
					for (T = 0; T < w; T++)(A = M[T]) ? A.innerHTML = "" : (A = M[T] = _p("tspan"), o.appendChild(A), Tp(A,
						"alignment-baseline", d), Tp(A, "text-anchor", b)), Tp(A, "x", a), Tp(A, "y", s + T * f + S), A.appendChild(
				...
				var d = function() {
					for (var n = -1 * a; n <= a; n += 2) {
						...
						var d = h && h.newPos + 1 < r,
							f = u && 0 <= c && c < o;
						if (d || f) {
							if (!d || f && h.newPos < u.newPos ? (s = Op(u), i.pushComponent(s.components, void 0, !0)) : ((s = h).newPos++,
									i.pushComponent(s.components, !0, void 0)), c = i.extractCommon(s, e, t, n), s.newPos + 1 >= r && c + 1 >=
								o) return Lp(0, s.components);
							l[n] = s
						} else l[n] = void 0
					}
					a++
	...
	zp.prototype.createElement = _p, zp.prototype.getDefs = function(t) {
		...
		if (t.style) {
			var e = t.style.fill;
			e && e._dom && zp.prototype.markUsed.call(this, e._dom), (e = t.style.stroke) && e._dom && zp.prototype.markUsed.call(
				this, e._dom)
		}
		...
		if (e && e.length > 0) {
			...
			i.innerHTML = "", i.appendChild(u.cloneNode()), t.setAttribute("clip-path", "url(#" + r + ")"), e.length > 1 &&
		...
		var u = o / 2 / l + " " + o / 2 / h;
		n.setAttribute("stdDeviation", u), e.setAttribute("x", "-100%"), e.setAttribute("y", "-100%"), e.setAttribute(
	...
	var kT = function(t, e, n, i) {
		...
		r.setAttribute("xmlns", "http://www.w3.org/2000/svg"), r.setAttribute("version", "1.1"), r.setAttribute(
			...
			new Ep(i, r), this.clipPathManager = new Np(i, r), this.shadowManager = new Rp(i, r);
	...
	kT.prototype = {
					...
					if (c.added)
						for (d = 0; d < c.count; d++) {
							var s = Xp(f = o[c.indices[d]]),
								u = Up(f);
							l ? Wp(n, s, l) : Gp(n, s), s ? Wp(n, u, s) : l ? Wp(n, u, l) : Gp(n, u), Wp(n, u, s), l = u || s || l, this.gradientManager
								.addWithoutUpdate(s, f), this.shadowManager.addWithoutUpdate(l, f), this.clipPathManager.markUsed(f)
						} else if (!c.removed)
							for (var d = 0; d < c.count; d++) {
								var f = o[c.indices[d]];
								l = s = Up(f) || Xp(f) || l, this.gradientManager.markUsed(f), this.gradientManager.addWithoutUpdate(s, f),
		...
		}, t.registerLayout = Ss, t.registerVisual = Ms, t.registerLoading = Ts, t.extendComponentModel = As, t.extendComponentView =
		Cs, t.extendSeriesModel = Ds, t.extendChartView = ks, t.setCanvasCreator = function(t) {
			e("createCanvas", t)
		...
		}, t.dataTool = dw, t.zrender = qm, t.number = Qy, t.format = ax, t.throttle = _a, t.helper = ab, t.matrix = Dg, t.vector =
		vg, t.color = jg, t.parseGeoJSON = lb, t.parseGeoJson = db, t.util = fb, t.graphic = pb, t.List = Sw, t.Model = Ir,
		t.Axis = cb, t.env = Kp
});
